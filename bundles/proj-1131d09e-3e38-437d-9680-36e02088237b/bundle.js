...
const Heading = ({ title, subtitle }) => {
  ...
  const translateY = (0,esm.interpolate)(opacity, [0, 1], [20, 0]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { textAlign: "center", opacity, transform: `translateY(${translateY}px)` }, children: [
    ...
    subtitle && /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      width: (0,esm.interpolate)(opacity, [0, 1], [0, 200]),
      height: "4px",
...
const TranscriptVisual = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "80%", background: "white", padding: "60px", borderRadius: "10px", boxShadow: "0 10px 30px rgba(0,0,0,0.1)", border: `2px solid ${constants_COLORS.accent}` }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontFamily: FONTS.serif, fontSize: "60px", color: constants_COLORS.primary, lineHeight: 1.4 }, children: lines.map((line, i) => {
      const lineOpacity = (0,esm.spring)({
        frame: frame - i * 15,
        fps,
        config: { damping: 12 }
      });
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: lineOpacity, transform: `translateX(${(0,esm.interpolate)(lineOpacity, [0, 1], [-20, 0])}px)` }, children: line }, i);
    }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginTop: "40px", height: "10px", width: "100%", background: constants_COLORS.lightGray, borderRadius: "5px", overflow: "hidden" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { height: "100%", width: `${progress * 100}%`, background: constants_COLORS.accent } }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginTop: "20px", textAlign: "right", fontFamily: FONTS.sans, color: constants_COLORS.gray, fontSize: "24px" }, children: "Timeline Accuracy: 99.8%" })
  ] }) });
};
...
const SpeedGauges = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const fastScale = (0,esm.spring)({
    frame: frame - 10,
    fps,
    config: { damping: 12 }
  });
  const slowScale = (0,esm.spring)({
    frame: frame - 25,
    fps,
    config: { damping: 12 }
  });
  const fastRotation = (0,esm.interpolate)(frame, [15, 60], [0, 180], { extrapolateRight: "clamp" });
  const slowRotation = (0,esm.interpolate)(frame, [30, 80], [0, 45], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { flexDirection: "row", justifyContent: "space-around", alignItems: "center", padding: "100px" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { transform: `scale(${fastScale})`, textAlign: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "300px", height: "150px", background: "white", border: `3px solid ${constants_COLORS.primary}`, borderRadius: "150px 150px 0 0", position: "relative", overflow: "hidden" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", bottom: 0, left: "50%", width: "140px", height: "4px", background: constants_COLORS.accent, transformOrigin: "left center", transform: `translateX(0) rotate(${180 + fastRotation}deg)` } }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", bottom: "10px", left: "50%", transform: "translateX(-50%)", fontFamily: FONTS.sans, color: constants_COLORS.primary, fontWeight: "bold" }, children: "FAST" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginTop: "20px", fontFamily: FONTS.serif, fontSize: "32px", color: constants_COLORS.primary }, children: "Rapid Speech" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { transform: `scale(${slowScale})`, textAlign: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "300px", height: "150px", background: "white", border: `3px solid ${constants_COLORS.primary}`, borderRadius: "150px 150px 0 0", position: "relative", overflow: "hidden" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", bottom: 0, left: "50%", width: "140px", height: "4px", background: constants_COLORS.accent, transformOrigin: "left center", transform: `translateX(0) rotate(${180 + slowRotation}deg)` } }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", bottom: "10px", left: "50%", transform: "translateX(-50%)", fontFamily: FONTS.sans, color: constants_COLORS.primary, fontWeight: "bold" }, children: "SLOW" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginTop: "20px", fontFamily: FONTS.serif, fontSize: "32px", color: constants_COLORS.primary }, children: "Deliberate Pace" })
    ] })
  ] });
};
...
const Proj1131d09e3e38437d968036e02088237b = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: constants_COLORS.background }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: constants_TIMING.scenes.intro.start, durationInFrames: constants_TIMING.scenes.intro.end - constants_TIMING.scenes.intro.start, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Heading, { title: "Railify", subtitle: "Temporal Accuracy Study" }) }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: constants_TIMING.scenes.transcripts.start, durationInFrames: constants_TIMING.scenes.transcripts.end - constants_TIMING.scenes.transcripts.start, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(TranscriptVisual, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: constants_TIMING.scenes.speed.start, durationInFrames: constants_TIMING.scenes.speed.end - constants_TIMING.scenes.speed.start, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SpeedGauges, {}) })
  ] });
};
const proj_1131d09e_3e38_437d_9680_36e02088237b = (/* unused pure expression or super */ null && (Proj1131d09e3e38437d968036e02088237b));
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Composition,
      {
        id: "proj-1131d09e-3e38-437d-9680-36e02088237b",
        component: Proj1131d09e3e38437d968036e02088237b,
        durationInFrames: 637,
        fps: 32,
        width: 1920,
        height: 1080
