...
const CageBar = ({ x, y, width, height, rotation = 0, stressFracture = 0 }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      children: stressFracture > 0 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            position: "absolute",
...
const Scene1 = ({ startFrame }) => {
  ...
  if (bounceIndex === 0) {
    sparkOffsetX = (0,esm.interpolate)(bounceProgress, [0, 0.5, 1], [-cageWidth * 0.35, 0, cageWidth * 0.35], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
    sparkOffsetY = (0,esm.interpolate)(bounceProgress, [0, 0.5, 1], [0, -cageHeight * 0.3, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
    squash = bounceProgress > 0.9 ? 1 + (bounceProgress - 0.9) * 3 : 1;
  } else if (bounceIndex === 1) {
    sparkOffsetX = cageWidth * 0.35;
    sparkOffsetY = (0,esm.interpolate)(bounceProgress, [0, 0.3, 0.5, 1], [0, -cageHeight * 0.45, -cageHeight * 0.45, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
    squash = bounceProgress < 0.1 ? 1.3 - bounceProgress * 3 : bounceProgress > 0.9 ? 1 + (bounceProgress - 0.9) * 2 : 1;
  } else if (bounceIndex === 2) {
    sparkOffsetX = (0,esm.interpolate)(bounceProgress, [0, 0.5, 1], [cageWidth * 0.35, 0, -cageWidth * 0.35], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
    sparkOffsetY = (0,esm.interpolate)(bounceProgress, [0, 0.5, 1], [0, -cageHeight * 0.25, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
    squash = bounceProgress > 0.9 ? 1 + (bounceProgress - 0.9) * 3 : 1;
  } else {
    sparkOffsetX = -cageWidth * 0.35;
    sparkOffsetY = (0,esm.interpolate)(bounceProgress, [0, 0.4, 0.6, 1], [0, cageHeight * 0.3, cageHeight * 0.3, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
  ...
  const colorTransition = (0,esm.interpolate)(
    localFrame,
  ...
  const stressFractureProgress = (0,esm.interpolate)(
    localFrame,
    [sceneDuration * 0.7, sceneDuration],
    [0, 1],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
  );
  const text1Opacity = (0,esm.interpolate)(
    localFrame,
    [10, 30, 60, 75],
    [0, 1, 1, 0],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
  );
  const text2Opacity = (0,esm.interpolate)(
    localFrame,
...
const CageFragment = ({ delay, angle, distance, width, height, localFrame, fps }) => {
...
const EnergyParticle = ({ delay, angle, maxDistance, size, localFrame, fps, color }) => {
  const progress = (0,esm.spring)({
    frame: Math.max(0, localFrame - delay),
    fps,
    config: { damping: 20, stiffness: 100, mass: 0.6 }
  });
  const outProgress = (0,esm.interpolate)(
    progress,
    [0, 0.5, 1],
    [0, 1, 0.3],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
...
const Scene2 = ({ startFrame }) => {
  ...
  const anticipation = (0,esm.interpolate)(
    localFrame,
    [0, 8, 10],
    [1, 0.95, 1],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
  ...
  const logoPulse = (0,esm.interpolate)(
  ...
  const sparkScale = (0,esm.spring)({
    frame: Math.max(0, localFrame - explosionFrame - 5),
    fps,
    config: SPRING_SNAPPY
  });
  const sparkGlow = (0,esm.interpolate)(
    localFrame,
    [explosionFrame, explosionFrame + 30, sceneDuration],
    [1, 2, 1.5],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
  );
  const textOpacity = (0,esm.interpolate)(
    localFrame,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          hasExploded && fragments.map((frag, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
            CageFragment,
            {
              delay: frag.delay,
              angle: frag.angle,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: hasExploded && particles.map((particle, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          EnergyParticle,
          {
    ...
    hasExploded && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      CreativeSpark,
      {
        x: centerX,
        y: centerY,
...
const MotionGraphicElement = ({ type, x, y, size, color, delay, localFrame, fps, rotation = 0 }) => {
  const progress = (0,esm.spring)({
    frame: Math.max(0, localFrame - delay),
    fps,
    config: SPRING_CONFIG
  ...
  switch (type) {
    case "circle":
      shape = /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            width: size,
...
const UploadInterface = ({ progress, glow, width, height }) => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width: "32", height: "32", viewBox: "0 0 24 24", fill: "none", children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "path",
                {
...
const Scene3 = ({ startFrame }) => {
  ...
  const uploadEntrance = (0,esm.spring)({
    frame: localFrame,
    fps,
    config: SPRING_CONFIG
  });
  const anticipationGlow = (0,esm.interpolate)(
    localFrame,
    [keyFrame - 30, keyFrame - 5, keyFrame],
    [0.3, 1, 0],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
  );
  const uploadOpacity = (0,esm.interpolate)(
    localFrame,
  ...
  const uploadTextOpacity = (0,esm.interpolate)(
    localFrame,
    [10, 25, keyFrame - 20, keyFrame - 5],
    [0, 1, 1, 0],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
  );
  const magicTextOpacity = (0,esm.interpolate)(
    localFrame,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    ...
    graphicsStarted && elements.map((el, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
    ...
    graphicsStarted && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
...
const DissolutionParticle = ({ startX, startY, delay, localFrame, fps, color, size, direction }) => {
  const progress = (0,esm.spring)({
    frame: Math.max(0, localFrame - delay),
    fps,
...
const Barrier = ({ label, icon, x, y, dissolveStart, localFrame, fps, width, height }) => {
  const entranceProgress = (0,esm.spring)({
    frame: localFrame,
    fps,
    config: SPRING_CONFIG
  });
  const dissolveProgress = (0,esm.spring)({
  ...
  const renderIcon = () => {
    switch (icon) {
      case "software":
        return /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width: "36", height: "36", viewBox: "0 0 24 24", fill: "none", children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: "3", y: "3", width: "18", height: "14", rx: "2", stroke: COLORS.frustrationStart, strokeWidth: "2" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("path", { d: "M7 21H17M12 17V21", stroke: COLORS.frustrationStart, strokeWidth: "2", strokeLinecap: "round" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("path", { d: "M7 8H10M7 11H14", stroke: COLORS.frustrationStart, strokeWidth: "2", strokeLinecap: "round" })
        ] });
      case "price":
        return /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: "36", height: "36", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ (0,jsx_runtime.jsx)("path", { d: "M12 2V22M17 5H9.5C8.57174 5 7.6815 5.36875 7.02513 6.02513C6.36875 6.6815 6 7.57174 6 8.5C6 9.42826 6.36875 10.3185 7.02513 10.9749C7.6815 11.6313 8.57174 12 9.5 12H14.5C15.4283 12 16.3185 12.3687 16.9749 13.0251C17.6313 13.6815 18 14.5717 18 15.5C18 16.4283 17.6313 17.3185 16.9749 17.9749C16.3185 18.6313 15.4283 19 14.5 19H6", stroke: COLORS.frustrationStart, strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) });
      case "skill":
        return /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width: "36", height: "36", viewBox: "0 0 24 24", fill: "none", children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("path", { d: "M12 15L8.5 21L9.5 17L6 16L12 9L11.5 13L15 14L12 15Z", stroke: COLORS.frustrationStart, strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: "12", cy: "12", r: "9", stroke: COLORS.frustrationStart, strokeWidth: "2" })
        ] });
    }
  };
...
const Scene4 = ({ startFrame }) => {
  ...
  const no1Progress = (0,esm.spring)({
    frame: Math.max(0, localFrame - keyFrame),
    fps,
    config: SPRING_CONFIG
  });
  const no2Progress = (0,esm.spring)({
    frame: Math.max(0, localFrame - keyFrame - 30),
    fps,
    config: SPRING_CONFIG
  });
  const no3Progress = (0,esm.spring)({
  ...
  const clearPathOpacity = (0,esm.interpolate)(
    localFrame,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          ...
          opacity: no1Progress * (0,esm.interpolate)(localFrame, [barrier1Dissolve + 40, barrier1Dissolve + 60], [1, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" })
        },
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "span",
          {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          ...
          opacity: no2Progress * (0,esm.interpolate)(localFrame, [barrier2Dissolve + 40, barrier2Dissolve + 60], [1, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" })
        },
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "span",
          {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          ...
          opacity: no3Progress * (0,esm.interpolate)(localFrame, [barrier3Dissolve + 50, sceneDuration], [1, 0.8], { extrapolateRight: "clamp", extrapolateLeft: "clamp" })
        },
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "span",
          {
...
const EnergyStream = ({ startX, startY, endX, endY, delay, localFrame, fps, color, width }) => {
  const progress = (0,esm.spring)({
    frame: Math.max(0, localFrame - delay),
    fps,
  ...
  const streamLength = (0,esm.interpolate)(
    progress,
    [0, 0.5, 1],
    [100, 80, 20],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
...
const ConvergenceParticle = ({ angle, distance, delay, localFrame, fps, color, endX, endY }) => {
  const progress = (0,esm.spring)({
    frame: Math.max(0, localFrame - delay),
    fps,
  ...
  const x = (0,esm.interpolate)(progress, [0, 1], [startX, endX], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
  const y = (0,esm.interpolate)(progress, [0, 1], [startY, endY], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
  const opacity = (0,esm.interpolate)(
    progress,
    [0, 0.3, 0.9, 1],
    [0, 1, 1, 0],
...
const Scene5 = ({ startFrame }) => {
  ...
  const ctaEntrance = (0,esm.spring)({
    frame: Math.max(0, localFrame - keyFrame + 30),
    fps,
    config: SPRING_GENTLE
  });
  const ctaPulse = (0,esm.interpolate)(
  ...
  const urgencyOpacity = (0,esm.interpolate)(
    localFrame,
    [keyFrame - 50, keyFrame - 30, sceneDuration - 30, sceneDuration],
    [0, 1, 1, 0.8],
    { extrapolateRight: "clamp", extrapolateLeft: "clamp" }
  );
  const brandOpacity = (0,esm.interpolate)(
    localFrame,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    streams.map((stream, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      EnergyStream,
      {
    ...
    localFrame > sceneDuration - 30 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
...
const MainComposition = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.background }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(Background, {}, "bg"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        from: TIMING.scene1Start,
        durationInFrames: TIMING.scene1End - TIMING.scene1Start,
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene1, { startFrame: 0 })
      },
      "scene1"
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene2, { startFrame: 0 })
      },
      "scene2"
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene3, { startFrame: 0 })
      },
      "scene3"
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene4, { startFrame: 0 })
      },
      "scene4"
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene5, { startFrame: 0 })
      },
      "scene5"
    )
  ] });
