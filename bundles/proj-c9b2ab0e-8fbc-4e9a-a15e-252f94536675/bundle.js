...
const CommentBlock = ({ id, color, size, y, opacity, style }) => {
...
const Scene1 = () => {
  ...
  const s1Comments = (0,react.useMemo)(() => Array.from({ length: 20 }).map((_, i) => ({ id: i + 1, delay: i * 8 })), []);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg }, children: s1Comments.map((c) => {
    const localFrame = frame - c.delay;
    if (localFrame < 0) return null;
    const s1Speed = (0,esm.interpolate)(localFrame, [0, 100], [1, 2], { extrapolateRight: "clamp" });
    const s1y = (0,esm.interpolate)(localFrame * s1Speed, [0, 60], [-100, height + 100]);
    const s1op = (0,esm.interpolate)(s1y, [0, 200, height - 200, height], [0, 1, 1, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(CommentBlock, { id: c.id, color: COLORS.primary, size: s1CommentSize, y: s1y, opacity: s1op }, c.id);
  }) });
};
const Scene2 = () => {
  const frame = (0,esm.useCurrentFrame)();
  ...
  const s2Comments = (0,react.useMemo)(() => Array.from({ length: 15 }).map((_, i) => ({ id: i + 20, delay: i * 10 })), []);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg }, children: s2Comments.map((c) => {
    ...
    const s2y = (0,esm.interpolate)(lFrame * s2Speed, [0, 60], [-100, height + 100]);
    const s2op = (0,esm.interpolate)(s2y, [0, 200, height - 200, height], [0, 1, 1, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
    const s2Scale = winner ? (0,esm.interpolate)(lFrame, [10, 30], [1, 1.3], { extrapolateRight: "clamp" }) : 1;
    const s2Glow = winner ? (0,esm.interpolate)(lFrame, [10, 30], [0, 20], { extrapolateRight: "clamp" }) : 0;
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(CommentBlock, { id: c.id, color: s2Color, size: s2CommentSize, y: s2y, opacity: s2op, style: { transform: `translateX(-50%) scale(${s2Scale})`, boxShadow: `0 0 ${s2Glow}px ${COLORS.accent}` } }, c.id);
  }) });
};
const Scene3 = () => {
  const frame = (0,esm.useCurrentFrame)();
  ...
  const minDim = Math.min(width, height);
  const s3BoxSpring = (0,esm.spring)({ frame: frame - 10, fps, config: SPRING_SETTLED });
  const s3Overflow = frame >= 80;
  const s3Shake = s3Overflow ? Math.sin(frame * 2) * (0,esm.interpolate)(frame, [80, 120], [0, 1], { extrapolateRight: "clamp" }) * 10 : 0;
  const s3ColP = (0,esm.interpolate)(frame, [80, 110], [0, 1], { extrapolateRight: "clamp" });
  const s3Color = `rgb(${(0,esm.interpolate)(s3ColP, [0, 1], [59, 239])}, ${(0,esm.interpolate)(s3ColP, [0, 1], [130, 68])}, ${(0,esm.interpolate)(s3ColP, [0, 1], [246, 68])})`;
  const s3Blocks = (0,react.useMemo)(() => Array.from({ length: 12 }), []);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg, display: "flex", justifyContent: "center", alignItems: "center" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: minDim * 0.6, height: minDim * 0.6, border: `4px solid ${s3Overflow ? COLORS.danger : COLORS.secondary}`, borderRadius: 20, backgroundColor: s3Color, display: "flex", flexWrap: "wrap", padding: 20, gap: 10, transform: `scale(${s3BoxSpring}) translate(${s3Shake}px, 0px)`, position: "relative", overflow: "hidden" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: 10, left: 10, color: "white", fontWeight: "bold", fontSize: 24 }, children: "RAM" }),
      s3Blocks.map((_, i) => {
        const bFrame = frame - 20 - i * 5;
        const bScale = (0,esm.spring)({ frame: bFrame, fps, config: SPRING_SETTLED });
        return bFrame >= 0 ? /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: "20%", height: "20%", backgroundColor: COLORS.white, borderRadius: 5, transform: `scale(${bScale})` } }, i) : null;
      })
    ] }),
    frame > 110 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: height * 0.3, fontSize: 120, opacity: (0,esm.interpolate)(frame, [110, 130], [0, 1], { extrapolateRight: "clamp" }) }, children: "\u2753" })
  ] });
};
const Scene4 = () => {
  const frame = (0,esm.useCurrentFrame)();
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg, display: "flex", justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", gap: 5 }, children: text.split("").map((char, i) => {
    const d = i * 3;
    const op = (0,esm.interpolate)(frame - 10 - d, [0, 10], [0, 1], { extrapolateRight: "clamp" });
    const ty = (0,esm.interpolate)(frame - 10 - d, [0, 10], [20, 0], { extrapolateRight: "clamp" });
    return /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: COLORS.accent, fontSize: height * 0.06, fontWeight: 800, opacity: op, transform: `translateY(${ty}px)`, textShadow: `0 0 15px ${COLORS.accent}44` }, children: char === " " ? "\xA0" : char }, i);
  }) }) });
};
const Scene5 = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const minDim = Math.min(width, height);
  const s5ResScale = (0,esm.spring)({ frame: frame - 10, fps, config: SPRING_SETTLED });
  const s5Slide = (0,esm.spring)({ frame: frame - 70, fps, config: SPRING_SETTLED });
  const s5cX = (0,esm.interpolate)(s5Slide, [0, 1], [-200, width * 0.2]);
  const s5Rot = (0,esm.interpolate)(frame - 90, [0, 30], [0, 360], { extrapolateRight: "clamp" });
  const s5DieOp = (0,esm.interpolate)(frame - 90, [0, 10], [0, 1], { extrapolateRight: "clamp" });
  const s5FormOp = (0,esm.interpolate)(frame - 160, [0, 20], [0, 1], { extrapolateRight: "clamp" });
  const s5SwapF = 240;
  const s5IsSwap = frame >= s5SwapF;
  const s5SwapS = (0,esm.spring)({ frame: frame - s5SwapF, fps, config: SPRING_SETTLED });
  const s5OldX = s5IsSwap ? (0,esm.interpolate)(s5SwapS, [0, 1], [width * 0.5, width * 1.2], { extrapolateRight: "clamp" }) : width * 0.5;
  const s5NewX = s5IsSwap ? (0,esm.interpolate)(s5SwapS, [0, 1], [width * 0.2, width * 0.5], { extrapolateRight: "clamp" }) : s5cX;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: "20%", left: "50%", transform: "translateX(-50%)", fontSize: 60, color: COLORS.accent, fontWeight: "bold", opacity: s5FormOp }, children: "P = 1/n" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: "30%", left: "50%", transform: `translateX(-50%) rotate(${s5Rot}deg)`, fontSize: 80, opacity: s5DieOp }, children: "\u{1F3B2}" }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "absolute", left: "50%", top: "50%", transform: `translate(-50%, -50%) scale(${s5ResScale})`, width: minDim * 0.3, height: minDim * 0.3, border: `4px solid ${COLORS.accent}`, borderRadius: 20, boxShadow: `0 0 20px ${COLORS.accent}44` }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { textAlign: "center", color: "white", marginTop: 10 }, children: "Winner" }),
      (!s5IsSwap || frame < s5SwapF + 20) && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: "50%", top: "60%", transform: `translate(-50%, -50%) translateX(${s5OldX - width * 0.5}px)`, width: "80%", height: "40%", backgroundColor: COLORS.primary, borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center" }, children: "ID: 15" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: s5NewX, top: "50%", transform: `translate(-50%, -50%)`, width: minDim * 0.2, height: minDim * 0.12, backgroundColor: COLORS.accent, borderRadius: 10, display: s5IsSwap && frame > s5SwapF + 10 ? "flex" : frame > 70 ? "flex" : "none", alignItems: "center", justifyContent: "center", color: "white", fontWeight: "bold" }, children: "ID: n" }),
    s5IsSwap && frame < s5SwapF + 30 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: "50%", top: "50%", transform: "translate(-50%, -50%)", width: 100, height: 100, borderRadius: "50%", backgroundColor: "white", opacity: (0,esm.interpolate)(frame - s5SwapF, [0, 10], [0.8, 0], { extrapolateRight: "clamp" }) } })
  ] });
};
const Scene6 = () => {
  const frame = (0,esm.useCurrentFrame)();
  ...
  const s6Split = (0,esm.spring)({ frame: frame - 10, fps, config: SPRING_SETTLED });
  const s6Bs = Array.from({ length: 5 });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "relative", height: minDim * 0.5, width: "100%", display: "flex", justifyContent: "center", alignItems: "center", gap: 20 }, children: s6Bs.map((_, i) => {
      const off = (i - 2) * (minDim * 0.18) * s6Split;
      const sc = (0,esm.interpolate)(s6Split, [0, 1], [1.5, 1], { extrapolateRight: "clamp" });
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: minDim * 0.15, height: minDim * 0.15, border: `3px solid ${COLORS.accent}`, borderRadius: 10, transform: `translateX(${off}px) scale(${sc})`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: 20 }, children: "W" }, i);
    }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginTop: 50, fontSize: 80, color: COLORS.accent, fontWeight: "bold", opacity: (0,esm.interpolate)(frame - 100, [0, 20], [0, 1], { extrapolateRight: "clamp" }), transform: `scale(${(0,esm.spring)({ frame: frame - 100, fps, config: SPRING_SETTLED })})` }, children: "P = ? / n" })
  ] });
};
const Scene7 = () => {
  const frame = (0,esm.useCurrentFrame)();
  ...
  const minDim = Math.min(width, height);
  const pScale = (0,esm.spring)({ frame: frame - 10, fps, config: SPRING_SETTLED });
  const op = (0,esm.interpolate)(frame - 40, [0, 20], [0, 1], { extrapolateRight: "clamp" });
  const s7h = height;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: minDim * 0.04 }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: minDim * 0.3, height: minDim * 0.3, borderRadius: "50%", backgroundColor: COLORS.primary, display: "flex", alignItems: "center", justifyContent: "center", fontSize: minDim * 0.1, transform: `scale(${pScale})`, border: `${minDim * 0.01}px solid ${COLORS.accent}` }, children: "\u{1F468}\u200D\u{1F4BB}" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: "white", fontSize: minDim * 0.06, fontWeight: "bold", opacity: op }, children: "Prasanna" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: COLORS.accent, fontSize: minDim * 0.04, opacity: (0,esm.interpolate)(frame - 60, [0, 20], [0, 1], { extrapolateRight: "clamp" }) }, children: "Technical Architect @ Zoho" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", gap: minDim * 0.04, marginTop: minDim * 0.04 }, children: ["Follow", "Share"].map((t, i) => {
      const s = (0,esm.spring)({ frame: frame - (120 + i * 20), fps, config: { ...SPRING_SETTLED, damping: 15 } });
      return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { padding: `${minDim * 0.02}px ${minDim * 0.04}px`, borderRadius: 50, backgroundColor: COLORS.accent, color: "white", fontSize: minDim * 0.032, fontWeight: "bold", transform: `scale(${s})`, boxShadow: `0 0 20px ${COLORS.accent}66` }, children: t }, i);
    }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "none" }, children: s7h })
  ] });
};
const ProjC9b2ab0e8fbc4e9aA15e252f94536675 = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 150, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene1, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 180, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene2, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 300, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene3, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 810, durationInFrames: 150, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene4, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 960, durationInFrames: 690, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene5, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1650, durationInFrames: 330, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene6, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1980, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene7, {}) })
  ] });
};
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: "proj-c9b2ab0e-8fbc-4e9a-a15e-252f94536675",
      component: ProjC9b2ab0e8fbc4e9aA15e252f94536675,
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/*! tailwindcss v4.1.1 | MIT License | https://tailwindcss.com */\n@layer theme, base, components, utilities;\n@supports ((-webkit-hyphens: none) and (not (margin-trim: inline))) or ((-moz-orient: inline) and (not (color:rgb(from red r g b)))) {\n  @layer base {\n    *, ::before, ::after, ::backdrop {\n      --tw-rotate-x: rotateX(0);\n      --tw-rotate-y: rotateY(0);\n      --tw-rotate-z: rotateZ(0);\n      --tw-skew-x: skewX(0);\n      --tw-skew-y: skewY(0);\n      --tw-border-style: solid;\n      --tw-gradient-position: initial;\n      --tw-gradient-from: #0000;\n      --tw-gradient-via: #0000;\n      --tw-gradient-to: #0000;\n      --tw-gradient-stops: initial;\n      --tw-gradient-via-stops: initial;\n      --tw-gradient-from-position: 0%;\n      --tw-gradient-via-position: 50%;\n      --tw-gradient-to-position: 100%;\n      --tw-ordinal: initial;\n      --tw-slashed-zero: initial;\n      --tw-numeric-figure: initial;\n      --tw-numeric-spacing: initial;\n      --tw-numeric-fraction: initial;\n      --tw-shadow: 0 0 #0000;\n      --tw-shadow-color: initial;\n      --tw-shadow-alpha: 100%;\n      --tw-inset-shadow: 0 0 #0000;\n      --tw-inset-shadow-color: initial;\n      --tw-inset-shadow-alpha: 100%;\n      --tw-ring-color: initial;\n      --tw-ring-shadow: 0 0 #0000;\n      --tw-inset-ring-color: initial;\n      --tw-inset-ring-shadow: 0 0 #0000;\n      --tw-ring-inset: initial;\n      --tw-ring-offset-width: 0px;\n      --tw-ring-offset-color: #fff;\n      --tw-ring-offset-shadow: 0 0 #0000;\n      --tw-blur: initial;\n      --tw-brightness: initial;\n      --tw-contrast: initial;\n      --tw-grayscale: initial;\n      --tw-hue-rotate: initial;\n      --tw-invert: initial;\n      --tw-opacity: initial;\n      --tw-saturate: initial;\n      --tw-sepia: initial;\n      --tw-drop-shadow: initial;\n      --tw-drop-shadow-color: initial;\n      --tw-drop-shadow-alpha: 100%;\n      --tw-drop-shadow-size: initial;\n      --tw-ease: initial;\n    }\n  }\n}\n@layer theme {\n  :root, :host {\n    --font-sans: ui-sans-serif, system-ui, sans-serif, \"Apple Color Emoji\",\n      \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";\n    --font-mono: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas,\n      \"Liberation Mono\", \"Courier New\", monospace;\n    --color-cyan-500: oklch(0.715 0.143 215.221);\n    --color-purple-500: oklch(0.627 0.265 303.9);\n    --ease-out: cubic-bezier(0, 0, 0.2, 1);\n    --default-transition-duration: 150ms;\n    --default-transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n    --default-font-family: var(--font-sans);\n    --default-font-feature-settings: var(--font-sans--font-feature-settings);\n    --default-font-variation-settings: var(\n      --font-sans--font-variation-settings\n    );\n    --default-mono-font-family: var(--font-mono);\n    --default-mono-font-feature-settings: var(\n      --font-mono--font-feature-settings\n    );\n    --default-mono-font-variation-settings: var(\n      --font-mono--font-variation-settings\n    );\n  }\n}\n@layer base {\n  *, ::after, ::before, ::backdrop, ::file-selector-button {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n    border: 0 solid;\n  }\n  html, :host {\n    line-height: 1.5;\n    -webkit-text-size-adjust: 100%;\n    tab-size: 4;\n    font-family: var( --default-font-family, ui-sans-serif, system-ui, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\" );\n    font-feature-settings: var(--default-font-feature-settings, normal);\n    font-variation-settings: var( --default-font-variation-settings, normal );\n    -webkit-tap-highlight-color: transparent;\n  }\n  body {\n    line-height: inherit;\n  }\n  hr {\n    height: 0;\n    color: inherit;\n    border-top-width: 1px;\n  }\n  abbr:where([title]) {\n    -webkit-text-decoration: underline dotted;\n    text-decoration: underline dotted;\n  }\n  h1, h2, h3, h4, h5, h6 {\n    font-size: inherit;\n    font-weight: inherit;\n  }\n  a {\n    color: inherit;\n    -webkit-text-decoration: inherit;\n    text-decoration: inherit;\n  }\n  b, strong {\n    font-weight: bolder;\n  }\n  code, kbd, samp, pre {\n    font-family: var( --default-mono-font-family, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, \"Liberation Mono\", \"Courier New\", monospace );\n    font-feature-settings: var( --default-mono-font-feature-settings, normal );\n    font-variation-settings: var( --default-mono-font-variation-settings, normal );\n    font-size: 1em;\n  }\n  small {\n    font-size: 80%;\n  }\n  sub, sup {\n    font-size: 75%;\n    line-height: 0;\n    position: relative;\n    vertical-align: baseline;\n  }\n  sub {\n    bottom: -0.25em;\n  }\n  sup {\n    top: -0.5em;\n  }\n  table {\n    text-indent: 0;\n    border-color: inherit;\n    border-collapse: collapse;\n  }\n  :-moz-focusring {\n    outline: auto;\n  }\n  progress {\n    vertical-align: baseline;\n  }\n  summary {\n    display: list-item;\n  }\n  ol, ul, menu {\n    list-style: none;\n  }\n  img, svg, video, canvas, audio, iframe, embed, object {\n    display: block;\n    vertical-align: middle;\n  }\n  img, video {\n    max-width: 100%;\n    height: auto;\n  }\n  button, input, select, optgroup, textarea, ::file-selector-button {\n    font: inherit;\n    font-feature-settings: inherit;\n    font-variation-settings: inherit;\n    letter-spacing: inherit;\n    color: inherit;\n    border-radius: 0;\n    background-color: transparent;\n    opacity: 1;\n  }\n  :where(select:is([multiple], [size])) optgroup {\n    font-weight: bolder;\n  }\n  :where(select:is([multiple], [size])) optgroup option {\n    padding-inline-start: 20px;\n  }\n  ::file-selector-button {\n    margin-inline-end: 4px;\n  }\n  ::placeholder {\n    opacity: 1;\n    color: color-mix(in oklab, currentColor 50%, transparent);\n  }\n  textarea {\n    resize: vertical;\n  }\n  ::-webkit-search-decoration {\n    -webkit-appearance: none;\n  }\n  ::-webkit-date-and-time-value {\n    min-height: 1lh;\n    text-align: inherit;\n  }\n  ::-webkit-datetime-edit {\n    display: inline-flex;\n  }\n  ::-webkit-datetime-edit-fields-wrapper {\n    padding: 0;\n  }\n  ::-webkit-datetime-edit, ::-webkit-datetime-edit-year-field, ::-webkit-datetime-edit-month-field, ::-webkit-datetime-edit-day-field, ::-webkit-datetime-edit-hour-field, ::-webkit-datetime-edit-minute-field, ::-webkit-datetime-edit-second-field, ::-webkit-datetime-edit-millisecond-field, ::-webkit-datetime-edit-meridiem-field {\n    padding-block: 0;\n  }\n  :-moz-ui-invalid {\n    box-shadow: none;\n  }\n  button, input:where([type=\"button\"], [type=\"reset\"], [type=\"submit\"]), ::file-selector-button {\n    appearance: button;\n  }\n  ::-webkit-inner-spin-button, ::-webkit-outer-spin-button {\n    height: auto;\n  }\n  [hidden]:where(:not([hidden=\"until-found\"])) {\n    display: none !important;\n  }\n}\n@layer utilities {\n  .visible {\n    visibility: visible;\n  }\n  .absolute {\n    position: absolute;\n  }\n  .relative {\n    position: relative;\n  }\n  .static {\n    position: static;\n  }\n  .container {\n    width: 100%;\n    @media (width >= 40rem) {\n      max-width: 40rem;\n    }\n    @media (width >= 48rem) {\n      max-width: 48rem;\n    }\n    @media (width >= 64rem) {\n      max-width: 64rem;\n    }\n    @media (width >= 80rem) {\n      max-width: 80rem;\n    }\n    @media (width >= 96rem) {\n      max-width: 96rem;\n    }\n  }\n  .block {\n    display: block;\n  }\n  .flex {\n    display: flex;\n  }\n  .grid {\n    display: grid;\n  }\n  .hidden {\n    display: none;\n  }\n  .inline {\n    display: inline;\n  }\n  .inline-block {\n    display: inline-block;\n  }\n  .grow {\n    flex-grow: 1;\n  }\n  .rotate-360 {\n    rotate: 360deg;\n  }\n  .transform {\n    transform: var(--tw-rotate-x) var(--tw-rotate-y) var(--tw-rotate-z) var(--tw-skew-x) var(--tw-skew-y);\n  }\n  .items-center {\n    align-items: center;\n  }\n  .justify-center {\n    justify-content: center;\n  }\n  .rounded {\n    border-radius: 0.25rem;\n  }\n  .border {\n    border-style: var(--tw-border-style);\n    border-width: 1px;\n  }\n  .bg-gradient-to-r {\n    --tw-gradient-position: to right in oklab;\n    background-image: linear-gradient(var(--tw-gradient-stops));\n  }\n  .from-purple-500 {\n    --tw-gradient-from: var(--color-purple-500);\n    --tw-gradient-stops: var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position));\n  }\n  .to-cyan-500 {\n    --tw-gradient-to: var(--color-cyan-500);\n    --tw-gradient-stops: var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position));\n  }\n  .italic {\n    font-style: italic;\n  }\n  .tabular-nums {\n    --tw-numeric-spacing: tabular-nums;\n    font-variant-numeric: var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,);\n  }\n  .underline {\n    text-decoration-line: underline;\n  }\n  .shadow {\n    --tw-shadow: 0 1px 3px 0 var(--tw-shadow-color, rgb(0 0 0 / 0.1)), 0 1px 2px -1px var(--tw-shadow-color, rgb(0 0 0 / 0.1));\n    box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow);\n  }\n  .shadow\\/glow {\n    --tw-shadow: 0 1px 3px 0 var(--tw-shadow-color, rgb(0 0 0 / 0.1)), 0 1px 2px -1px var(--tw-shadow-color, rgb(0 0 0 / 0.1));\n    box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow);\n  }\n  .ring {\n    --tw-ring-shadow: var(--tw-ring-inset,) 0 0 0 calc(1px + var(--tw-ring-offset-width)) var(--tw-ring-color, currentColor);\n    box-shadow: var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow);\n  }\n  .blur {\n    --tw-blur: blur(8px);\n    filter: var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,);\n  }\n  .filter {\n    filter: var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,);\n  }\n  .transition {\n    transition-property: color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to, opacity, box-shadow, transform, translate, scale, rotate, filter, -webkit-backdrop-filter, backdrop-filter;\n    transition-timing-function: var(--tw-ease, var(--default-transition-timing-function));\n    transition-duration: var(--tw-duration, var(--default-transition-duration));\n  }\n  .ease-out {\n    --tw-ease: var(--ease-out);\n    transition-timing-function: var(--ease-out);\n  }\n}\n@property --tw-rotate-x {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: rotateX(0);\n}\n@property --tw-rotate-y {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: rotateY(0);\n}\n@property --tw-rotate-z {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: rotateZ(0);\n}\n@property --tw-skew-x {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: skewX(0);\n}\n@property --tw-skew-y {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: skewY(0);\n}\n@property --tw-border-style {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: solid;\n}\n@property --tw-gradient-position {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-gradient-from {\n  syntax: \"<color>\";\n  inherits: false;\n  initial-value: #0000;\n}\n@property --tw-gradient-via {\n  syntax: \"<color>\";\n  inherits: false;\n  initial-value: #0000;\n}\n@property --tw-gradient-to {\n  syntax: \"<color>\";\n  inherits: false;\n  initial-value: #0000;\n}\n@property --tw-gradient-stops {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-gradient-via-stops {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-gradient-from-position {\n  syntax: \"<length-percentage>\";\n  inherits: false;\n  initial-value: 0%;\n}\n@property --tw-gradient-via-position {\n  syntax: \"<length-percentage>\";\n  inherits: false;\n  initial-value: 50%;\n}\n@property --tw-gradient-to-position {\n  syntax: \"<length-percentage>\";\n  inherits: false;\n  initial-value: 100%;\n}\n@property --tw-ordinal {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-slashed-zero {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-numeric-figure {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-numeric-spacing {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-numeric-fraction {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-shadow {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: 0 0 #0000;\n}\n@property --tw-shadow-color {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-shadow-alpha {\n  syntax: \"<percentage>\";\n  inherits: false;\n  initial-value: 100%;\n}\n@property --tw-inset-shadow {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: 0 0 #0000;\n}\n@property --tw-inset-shadow-color {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-inset-shadow-alpha {\n  syntax: \"<percentage>\";\n  inherits: false;\n  initial-value: 100%;\n}\n@property --tw-ring-color {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-ring-shadow {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: 0 0 #0000;\n}\n@property --tw-inset-ring-color {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-inset-ring-shadow {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: 0 0 #0000;\n}\n@property --tw-ring-inset {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-ring-offset-width {\n  syntax: \"<length>\";\n  inherits: false;\n  initial-value: 0px;\n}\n@property --tw-ring-offset-color {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: #fff;\n}\n@property --tw-ring-offset-shadow {\n  syntax: \"*\";\n  inherits: false;\n  initial-value: 0 0 #0000;\n}\n@property --tw-blur {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-brightness {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-contrast {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-grayscale {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-hue-rotate {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-invert {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-opacity {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-saturate {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-sepia {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-drop-shadow {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-drop-shadow-color {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-drop-shadow-alpha {\n  syntax: \"<percentage>\";\n  inherits: false;\n  initial-value: 100%;\n}\n@property --tw-drop-shadow-size {\n  syntax: \"*\";\n  inherits: false;\n}\n@property --tw-ease {\n  syntax: \"*\";\n  inherits: false;\n}\n", "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA,gEACA;AADA,yCACA;AADA;EAAA;IAAA;MAAA,yBACA;MADA,yBACA;MADA,yBACA;MADA,qBACA;MADA,qBACA;MADA,wBACA;MADA,+BACA;MADA,yBACA;MADA,wBACA;MADA,uBACA;MADA,4BACA;MADA,gCACA;MADA,+BACA;MADA,+BACA;MADA,+BACA;MADA,qBACA;MADA,0BACA;MADA,4BACA;MADA,6BACA;MADA,8BACA;MADA,sBACA;MADA,0BACA;MADA,uBACA;MADA,4BACA;MADA,gCACA;MADA,6BACA;MADA,wBACA;MADA,2BACA;MADA,8BACA;MADA,iCACA;MADA,wBACA;MADA,2BACA;MADA,4BACA;MADA,kCACA;MADA,kBACA;MADA,wBACA;MADA,sBACA;MADA,uBACA;MADA,wBACA;MADA,oBACA;MADA,qBACA;MADA,sBACA;MADA,mBACA;MADA,yBACA;MADA,+BACA;MADA,4BACA;MADA,8BACA;MADA,kBACA;IAAA;EAAA;AAAA;AADA;EAAA;IAAA;6DACA;IADA;iDACA;IADA,4CACA;IADA,4CACA;IADA,sCACA;IADA,oCACA;IADA,kEACA;IADA,uCACA;IADA,wEACA;IADA;;KACA;IADA,4CACA;IADA;;KACA;IADA;;KACA;EAAA;AAAA;AADA;EAAA;IAAA,sBACA;IADA,SACA;IADA,UACA;IADA,eACA;EAAA;EADA;IAAA,gBACA;IADA,8BACA;IADA,WACA;IADA,6JACA;IADA,mEACA;IADA,yEACA;IADA,wCACA;EAAA;EADA;IAAA,oBACA;EAAA;EADA;IAAA,SACA;IADA,cACA;IADA,qBACA;EAAA;EADA;IAAA,yCACA;IADA,iCACA;EAAA;EADA;IAAA,kBACA;IADA,oBACA;EAAA;EADA;IAAA,cACA;IADA,gCACA;IADA,wBACA;EAAA;EADA;IAAA,mBACA;EAAA;EADA;IAAA,kJACA;IADA,0EACA;IADA,8EACA;IADA,cACA;EAAA;EADA;IAAA,cACA;EAAA;EADA;IAAA,cACA;IADA,cACA;IADA,kBACA;IADA,wBACA;EAAA;EADA;IAAA,eACA;EAAA;EADA;IAAA,WACA;EAAA;EADA;IAAA,cACA;IADA,qBACA;IADA,yBACA;EAAA;EADA;IAAA,aACA;EAAA;EADA;IAAA,wBACA;EAAA;EADA;IAAA,kBACA;EAAA;EADA;IAAA,gBACA;EAAA;EADA;IAAA,cACA;IADA,sBACA;EAAA;EADA;IAAA,eACA;IADA,YACA;EAAA;EADA;IAAA,aACA;IADA,8BACA;IADA,gCACA;IADA,uBACA;IADA,cACA;IADA,gBACA;IADA,6BACA;IADA,UACA;EAAA;EADA;IAAA,mBACA;EAAA;EADA;IAAA,0BACA;EAAA;EADA;IAAA,sBACA;EAAA;EADA;IAAA,UACA;IADA,yDACA;EAAA;EADA;IAAA,gBACA;EAAA;EADA;IAAA,wBACA;EAAA;EADA;IAAA,eACA;IADA,mBACA;EAAA;EADA;IAAA,oBACA;EAAA;EADA;IAAA,UACA;EAAA;EADA;IAAA,gBACA;EAAA;EADA;IAAA,gBACA;EAAA;EADA;IAAA,kBACA;EAAA;EADA;IAAA,YACA;EAAA;EADA;IAAA,wBACA;EAAA;AAAA;AADA;EAAA;IAAA,mBACA;EAAA;EADA;IAAA,kBACA;EAAA;EADA;IAAA,kBACA;EAAA;EADA;IAAA,gBACA;EAAA;EADA;IAAA,WACA;IADA;MAAA,gBACA;IAAA;IADA;MAAA,gBACA;IAAA;IADA;MAAA,gBACA;IAAA;IADA;MAAA,gBACA;IAAA;IADA;MAAA,gBACA;IAAA;EAAA;EADA;IAAA,cACA;EAAA;EADA;IAAA,aACA;EAAA;EADA;IAAA,aACA;EAAA;EADA;IAAA,aACA;EAAA;EADA;IAAA,eACA;EAAA;EADA;IAAA,qBACA;EAAA;EADA;IAAA,YACA;EAAA;EADA;IAAA,cACA;EAAA;EADA;IAAA,qGACA;EAAA;EADA;IAAA,mBACA;EAAA;EADA;IAAA,uBACA;EAAA;EADA;IAAA,sBACA;EAAA;EADA;IAAA,oCACA;IADA,iBACA;EAAA;EADA;IAAA,yCACA;IADA,2DACA;EAAA;EADA;IAAA,2CACA;IADA,8LACA;EAAA;EADA;IAAA,uCACA;IADA,8LACA;EAAA;EADA;IAAA,kBACA;EAAA;EADA;IAAA,kCACA;IADA,iJACA;EAAA;EADA;IAAA,+BACA;EAAA;EADA;IAAA,0HACA;IADA,sIACA;EAAA;EADA;IAAA,0HACA;IADA,sIACA;EAAA;EADA;IAAA,wHACA;IADA,sIACA;EAAA;EADA;IAAA,oBACA;IADA,0LACA;EAAA;EADA;IAAA,0LACA;EAAA;EADA;IAAA,mRACA;IADA,qFACA;IADA,2EACA;EAAA;EADA;IAAA,0BACA;IADA,2CACA;EAAA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,yBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,yBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,yBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,uBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,uBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,oBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,iBACA;EADA,eACA;EADA,oBACA;AAAA;AADA;EAAA,iBACA;EADA,eACA;EADA,oBACA;AAAA;AADA;EAAA,iBACA;EADA,eACA;EADA,oBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,6BACA;EADA,eACA;EADA,iBACA;AAAA;AADA;EAAA,6BACA;EADA,eACA;EADA,kBACA;AAAA;AADA;EAAA,6BACA;EADA,eACA;EADA,mBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,wBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,sBACA;EADA,eACA;EADA,mBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,wBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,sBACA;EADA,eACA;EADA,mBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,wBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,wBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,kBACA;EADA,eACA;EADA,kBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,mBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;EADA,wBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,sBACA;EADA,eACA;EADA,mBACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA;AADA;EAAA,WACA;EADA,eACA;AAAA","sourcesContent":["@import \"tailwindcss\";\n"],"sourceRoot":""}]);
// Exports
