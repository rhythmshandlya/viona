...
const LogoVisual = () => {
  ...
  const pulse = (0,esm.interpolate)(Math.sin(frame / 10), [-1, 1], [0.9, 1.1]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      ...
      width: "800px",
      height: "800px",
      background: `radial-gradient(circle, ${constants_COLORS.orange}44 0%, transparent 70%)`,
      transform: `scale(${pulse * scale})`,
      borderRadius: "50%"
    } }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      backgroundColor: constants_COLORS.orange,
      borderRadius: "80px",
      padding: "100px 150px",
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        height: "24px",
        width: "100%",
        backgroundColor: constants_COLORS.yellow,
        borderRadius: "12px",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      ...
      fontWeight: "800",
      fontFamily: "Plus Jakarta Sans, Inter, system-ui, sans-serif",
      opacity: (0,esm.interpolate)(frame, [0, 20], [0, 1]),
      transform: `translateY(${(0,esm.interpolate)(frame, [0, 20], [40, 0])}px)`,
      textAlign: "center",
...
const Word = ({ word, index, activeIndex }) => {
  const { fps } = (0,esm.useVideoConfig)();
  const frame = (0,esm.useCurrentFrame)();
  const isActive = index === activeIndex;
  const pop = (0,esm.spring)({
    frame: frame - index * 2,
    // Faster stagger
    fps,
    config: {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "span",
    {
      style: {
        ...
        marginRight: "25px",
        color: isActive ? constants_COLORS.yellow : index < activeIndex ? constants_COLORS.white : "rgba(255,255,255,0.3)",
        transform: `scale(${isActive ? 1.3 : pop})`,
        fontWeight: isActive ? "900" : "700",
        textShadow: isActive ? `0 0 20px ${constants_COLORS.yellow}66` : "none",
...
const TranscriptVisual = () => {
  ...
  const activeWordIndex = Math.floor((0,esm.interpolate)(frame, [0, 240], [0, words.length], {
    extrapolateRight: "clamp"
  }));
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: {
    ...
    textAlign: "center",
    color: constants_COLORS.white
  }, children: words.map((word, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(Word, { word, index: i, activeIndex: activeWordIndex }, i)) }) }) });
};
...
const SpeedVisual = () => {
  ...
  const fastX = (0,esm.interpolate)(frame % 15, [0, 15], [-250, width + 250]);
  const slowX = (0,esm.interpolate)(frame % 100, [0, 100], [-150, width + 150]);
  const entry = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 15, stiffness: 100 }
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        ...
        "FAST ",
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "130px" }, children: "\u{1F680}" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        width: "100%",
        height: "180px",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        ...
        "SLOW ",
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: "130px" }, children: "\u{1F422}" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        width: "100%",
        height: "180px",
...
const Background = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: {
    background: `radial-gradient(circle at 50% 50%, ${constants_COLORS.backgroundGradient[0]}, ${constants_COLORS.backgroundGradient[1]})`
  }, children: [
    [...Array(15)].map((_, i) => {
      ...
      const rotate = (0,esm.interpolate)(frame + i * 2, [0, 200], [0, 360]);
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            ...
            width: size,
            height: size,
            border: `2px solid ${constants_COLORS.white}`,
    ...
    [...Array(30)].map((_, i) => {
      ...
      const x = i * 73 % width;
      const opacity = (0,esm.interpolate)(y, [-50, 0, height, height + 50], [0, 0.4, 0.4, 0]);
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            ...
            width: 4,
            height: 4,
            backgroundColor: i % 3 === 0 ? constants_COLORS.orange : i % 3 === 1 ? constants_COLORS.yellow : constants_COLORS.white,
            borderRadius: "50%",
            opacity,
            boxShadow: `0 0 10px ${constants_COLORS.white}`
          }
        },
        `p-${i}`
      );
...
const ProjDd09f8eaE501439aB1cbBa00a7664ac6 = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(Background, {}),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: constants_TIMING.railifyStart, durationInFrames: constants_TIMING.railifyDuration, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(LogoVisual, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: constants_TIMING.transcriptStart, durationInFrames: constants_TIMING.transcriptDuration, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(TranscriptVisual, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: constants_TIMING.speedStart, durationInFrames: constants_TIMING.speedDuration, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SpeedVisual, {}) })
  ] });
};
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Composition,
      {
        id: "proj-dd09f8ea-e501-439a-b1cb-ba00a7664ac6",
        component: ProjDd09f8eaE501439aB1cbBa00a7664ac6,
