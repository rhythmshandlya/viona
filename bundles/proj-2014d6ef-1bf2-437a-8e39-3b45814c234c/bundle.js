...
const BigTitle = ({ text, color = constants_COLORS.primary, subtitle }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const r = useResponsive();
  const scale = (0,esm.spring)({ frame, fps, config: { damping: 12, stiffness: 120 } });
  const opacity = (0,esm.interpolate)(frame, [0, 20], [0, 1]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
    ...
    subtitle && /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: {
...
const BinaryHeap = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "relative", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: width * 0.5 + pos[0].x * width, y1: height * 0.5 + pos[0].y * height, x2: width * 0.5 + pos[1].x * width, y2: height * 0.5 + pos[1].y * height, stroke: constants_COLORS.primary, strokeWidth: r.borderWidth }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: width * 0.5 + pos[0].x * width, y1: height * 0.5 + pos[0].y * height, x2: width * 0.5 + pos[2].x * width, y2: height * 0.5 + pos[2].y * height, stroke: constants_COLORS.primary, strokeWidth: r.borderWidth }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: width * 0.5 + pos[1].x * width, y1: height * 0.5 + pos[1].y * height, x2: width * 0.5 + pos[3].x * width, y2: height * 0.5 + pos[3].y * height, stroke: constants_COLORS.primary, strokeWidth: r.borderWidth }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: width * 0.5 + pos[1].x * width, y1: height * 0.5 + pos[1].y * height, x2: width * 0.5 + pos[4].x * width, y2: height * 0.5 + pos[4].y * height, stroke: constants_COLORS.primary, strokeWidth: r.borderWidth }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: width * 0.5 + pos[2].x * width, y1: height * 0.5 + pos[2].y * height, x2: width * 0.5 + pos[5].x * width, y2: height * 0.5 + pos[5].y * height, stroke: constants_COLORS.primary, strokeWidth: r.borderWidth }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("line", { x1: width * 0.5 + pos[2].x * width, y1: height * 0.5 + pos[2].y * height, x2: width * 0.5 + pos[6].x * width, y2: height * 0.5 + pos[6].y * height, stroke: constants_COLORS.primary, strokeWidth: r.borderWidth })
    ] }),
    pos.map((p, i) => {
      const delay = i * 5;
      const scale = (0,esm.spring)({ frame: frame - delay, fps, config: { damping: 12, stiffness: 100 } });
      const shake = i === 0 ? Math.sin(frame * 0.5) * 5 * (0,esm.interpolate)(frame, [100, 150], [0, 1], { extrapolateRight: "clamp" }) : 0;
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            ...
            background: constants_COLORS.background,
            border: `${r.borderWidth}px solid ${i === 0 && frame > 100 ? constants_COLORS.accent : constants_COLORS.primary}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            color: i === 0 && frame > 100 ? constants_COLORS.accent : constants_COLORS.primary,
            fontSize: r.fontSize.md,
            fontWeight: 800,
            transform: `scale(${scale})`,
            boxShadow: i === 0 && frame > 100 ? `0 0 ${r.glow.lg}px ${constants_COLORS.accent}` : "none"
          },
          children: nodes[i]
        },
        i
...
const TimingWheel = ({ rotationOffset = 0 }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, height } = (0,esm.useVideoConfig)();
  const r = useResponsive();
  const minDim = Math.min(width, height);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
    ...
    height: wheelSize,
    borderRadius: "50%",
    border: `${r.borderWidth}px solid ${constants_COLORS.primary}`,
    position: "relative",
    transform: `rotate(${rotation}deg)`,
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    boxShadow: `0 0 ${r.glow.md}px ${constants_COLORS.primary}44`
  }, children: [
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            ...
            background: hasTask ? constants_COLORS.accent : "transparent",
            border: `${r.borderWidth * 0.5}px solid ${constants_COLORS.primary}`,
            boxShadow: hasTask ? `0 0 ${r.glow.sm}px ${constants_COLORS.accent}` : "none",
            transform: `rotate(${-rotation}deg)`
            // Keep tasks upright
          }
        },
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      ...
      boxShadow: `0 0 ${r.glow.sm}px ${constants_COLORS.accent}`
    } })
  ] });
};
const HierarchicalTimingWheel = () => {
  ...
  const { width } = (0,esm.useVideoConfig)();
  const r = useResponsive();
  const moveOut = (0,esm.interpolate)(frame, [0, 60], [0, 1], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: r.gap.xl, flexDirection: "row" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { transform: `translateX(${-moveOut * width * 0.15}px)` }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: constants_COLORS.primary, marginBottom: r.gap.sm, textAlign: "center", fontSize: r.fontSize.sm, fontWeight: "bold" }, children: "SECONDS WHEEL" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(TimingWheel, {})
    ] }),
    frame > 30 && /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { transform: `translateX(${moveOut * width * 0.15}px)`, opacity: moveOut }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: constants_COLORS.secondary, marginBottom: r.gap.sm, textAlign: "center", fontSize: r.fontSize.sm, fontWeight: "bold" }, children: "MINUTES WHEEL" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(TimingWheel, { rotationOffset: 45 })
    ] })
  ] });
};
...
const Proj2014d6ef1bf2437a8e393b45814c234c = () => {
  const r = useResponsive();
  let currentFrame = 0;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: constants_COLORS.background, color: constants_COLORS.text, fontFamily: "system-ui, sans-serif", overflow: "hidden" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentFrame, durationInFrames: constants_TIMING.intro, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BigTitle, { text: "SYSTEM DESIGN CHALLENGE", subtitle: "MILLIONS OF TASKS" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentFrame += constants_TIMING.intro, durationInFrames: constants_TIMING.priorityQueue, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", height: "100%" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: "0 0 20%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BigTitle, { text: "PRIORITY QUEUE", subtitle: "BINARY HEAP" }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: 1, position: "relative" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BinaryHeap, {}) })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentFrame += constants_TIMING.priorityQueue, durationInFrames: constants_TIMING.priorityQueueProblem, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", height: "100%" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: "0 0 20%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BigTitle, { text: "THE TRAP", color: constants_COLORS.accent, subtitle: "O(log n) TIME" }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: 1 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BinaryHeap, {}) })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentFrame += constants_TIMING.priorityQueueProblem, durationInFrames: constants_TIMING.bottleneck, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BigTitle, { text: "BOTTLENECK", color: constants_COLORS.accent, subtitle: "10,000,000 CONNECTIONS" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentFrame += constants_TIMING.bottleneck, durationInFrames: constants_TIMING.timingWheelIntro, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BigTitle, { text: "CONSTANT TIME", color: constants_COLORS.secondary, subtitle: "O(1) COMPLEXITY" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentFrame += constants_TIMING.timingWheelIntro, durationInFrames: constants_TIMING.clockFace + constants_TIMING.hierarchy, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", height: "100%" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: "0 0 20%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BigTitle, { text: "TIMING WHEEL", subtitle: "HIERARCHICAL CASCADING" }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { flex: 1 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(HierarchicalTimingWheel, {}) })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentFrame += constants_TIMING.clockFace + constants_TIMING.hierarchy, durationInFrames: constants_TIMING.kafkaNetty, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: r.gap.lg }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(BigTitle, { text: "REAL WORLD TECH", color: constants_COLORS.secondary }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: r.gap.xl }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { border: `${r.borderWidth}px solid ${constants_COLORS.primary}`, padding: r.padding, fontSize: r.fontSize.xl, fontWeight: "bold" }, children: "KAFKA" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { border: `${r.borderWidth}px solid ${constants_COLORS.primary}`, padding: r.padding, fontSize: r.fontSize.xl, fontWeight: "bold" }, children: "NETTY" })
      ] })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentFrame += constants_TIMING.kafkaNetty, durationInFrames: constants_TIMING.outro, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BigTitle, { text: "FOLLOW FOR MORE", subtitle: "@PRASANNA - ZOHO" }) })
  ] });
};
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Composition,
      {
        id: "proj-2014d6ef-1bf2-437a-8e39-3b45814c234c",
        component: Proj2014d6ef1bf2437a8e393b45814c234c,
