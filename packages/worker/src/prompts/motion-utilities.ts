/**
 * Motion utility code snippets for Apple/Google ad-style animations.
 * Injected into the AI prompt when stylePreset is 'apple' or 'google'.
 */

export const AD_MOTION_UTILITIES = `
