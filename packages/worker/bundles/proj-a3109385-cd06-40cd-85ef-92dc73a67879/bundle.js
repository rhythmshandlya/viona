...
const Scene1Setup = () => {
  ...
  const highSphereScale = (0,esm.spring)({
    frame,
    fps,
    config: SPRING_CONFIG
  });
  const lowSphereScale = (0,esm.spring)({
    frame: frame - 6,
    // 6 frame stagger
    fps,
    config: SPRING_CONFIG
...
const Scene2High = () => {
  ...
  const riseProgress = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 24, stiffness: 80, mass: 1 }
  });
  const highSphereY = (0,esm.interpolate)(
    riseProgress,
    [0, 1],
    [LAYOUT.highSphereInitY, LAYOUT.highSphereFinalY],
    { extrapolateRight: "clamp" }
  );
  const lowSphereY = (0,esm.interpolate)(
    riseProgress,
    [0, 1],
    [LAYOUT.lowSphereInitY, 0.7],
    { extrapolateRight: "clamp" }
  );
  const highGlow = (0,esm.interpolate)(
    riseProgress,
    [0, 1],
    [1, 2],
    { extrapolateRight: "clamp" }
  ...
  const pulseGlow = (0,esm.interpolate)(
    frame,
    [7, 10, 13, 16],
    [2, 2.5, 2, 2.3],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
...
const Scene3AndLow = () => {
  ...
  const connectionProgress = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 25, stiffness: 120, mass: 0.8 }
  });
  const connectionOpacity = (0,esm.interpolate)(
    frame,
    [0, 5, 10, 15],
    [0, 0.8, 0.8, 0],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
  );
  const descentProgress = (0,esm.spring)({
    frame: frame - 3,
    fps,
  ...
  const lowOpacity = (0,esm.interpolate)(
    Math.max(0, descentProgress),
    [0, 1],
    [0.7, 0.5],
    { extrapolateRight: "clamp" }
  ...
  const lowTextProgress = (0,esm.spring)({
    frame: frame - 3,
    fps,
    config: SPRING_CONFIG
  });
  const lowTextOpacity = (0,esm.interpolate)(
    frame,
    [3, 8, 16, 20],
    [0, 1, 1, 0.8],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
...
const MainComposition = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.dark }, children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: TIMING.scene1Start, durationInFrames: 34, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene1Setup, {}) }, "scene1"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: TIMING.scene2Start, durationInFrames: 18, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene2High, {}) }, "scene2"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: TIMING.scene3Start, durationInFrames: 22, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene3AndLow, {}) }, "scene3")
  ] });
};
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
...
/* harmony default export */ const proj_a3109385_cd06_40cd_85ef_92dc73a67879 = ((/* unused pure expression or super */ null && (MainComposition)));
