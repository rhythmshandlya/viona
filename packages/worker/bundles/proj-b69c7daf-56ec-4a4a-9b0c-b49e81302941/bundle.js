...
const FadeIn = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity }, children });
};
const SlideUp = ({
  children,
  delay = 0,
...
const ScaleIn = ({
  ...
  const scale = (0,esm.interpolate)(progress, [0, 1], [from, 1]);
  const opacity = (0,esm.interpolate)(progress, [0, 1], [0, 1]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
...
const Stagger = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: React.Children.map(children, (child, index) => /* @__PURE__ */ jsx(
    AnimationComponent,
    {
...
const TypeWriter = ({ text, startFrame = 0, charsPerFrame = 0.5 }) => {
  const frame = useCurrentFrame();
...
const CountUp = ({ from = 0, to, delay = 0, duration = 30, format = (n) => n.toFixed(0) }) => {
  const frame = useCurrentFrame();
  ...
  return /* @__PURE__ */ jsx("span", { children: format(value) });
};
...
const BounceIn = ({
  ...
  if (frame < delay) return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: 0 }, children });
  let scale;
  let opacity;
  if (t < 0.2) {
    scale = (0,esm.interpolate)(t, [0, 0.2], [0.3, 1.1]);
    opacity = (0,esm.interpolate)(t, [0, 0.2], [0, 1]);
  } else if (t < 0.4) {
    scale = (0,esm.interpolate)(t, [0.2, 0.4], [1.1, 0.9]);
    opacity = 1;
  } else if (t < 0.6) {
    scale = (0,esm.interpolate)(t, [0.4, 0.6], [0.9, 1.03]);
    opacity = 1;
  } else if (t < 0.8) {
    scale = (0,esm.interpolate)(t, [0.6, 0.8], [1.03, 0.97]);
    opacity = 1;
  } else {
    scale = (0,esm.interpolate)(t, [0.8, 1], [0.97, 1]);
    opacity = 1;
  }
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: `scale(${scale})`, opacity, transformOrigin: "center" }, children });
};
const FadeInUp = ({
  children,
  delay = 0,
  ...
  const config = SPRING_CONFIGS[style];
  if (frame < delay) return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: 0 }, children });
  const progress = (0,esm.spring)({ frame: frame - delay, fps, config, durationInFrames: dur });
  const translateY = (0,esm.interpolate)(progress, [0, 1], [distance, 0]);
  const opacity = (0,esm.interpolate)(progress, [0, 0.6], [0, 1], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: `translateY(${translateY}px)`, opacity }, children });
};
const FadeInDown = ({
  children,
  delay = 0,
  ...
  const dur = duration || PREMIUM_DURATIONS[style][speed];
  const config = SPRING_CONFIGS[style];
  if (frame < delay) return /* @__PURE__ */ jsx("div", { style: { opacity: 0 }, children });
  ...
  return /* @__PURE__ */ jsx("div", { style: { transform: `translateY(${translateY}px)`, opacity }, children });
};
const ZoomIn = ({
  children,
  delay = 0,
  ...
  const scale = (0,esm.interpolate)(progress, [0, 1], [0.3, 1]);
  const opacity = (0,esm.interpolate)(progress, [0, 0.4], [0, 1], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { transform: `scale(${scale})`, opacity, transformOrigin: "center" }, children });
};
const FlipInX = ({
  children,
...
const BounceOut = ({
  ...
  const dur = duration || PREMIUM_DURATIONS[style][speed];
  const t = Math.max(0, Math.min(1, (frame - delay) / dur));
  if (frame < delay) return /* @__PURE__ */ jsx("div", { children });
  let scale;
  let opacity;
  if (t < 0.2) {
  ...
  return /* @__PURE__ */ jsx("div", { style: { transform: `scale(${scale})`, opacity, transformOrigin: "center" }, children });
};
const FadeOutUp = ({
  children,
  delay = 0,
...
const Pulse = ({
  ...
  const scale = t < 0.5 ? interpolate(t, [0, 0.5], [1, intensity]) : interpolate(t, [0.5, 1], [intensity, 1]);
  return /* @__PURE__ */ jsx("div", { style: { transform: `scale(${scale})`, transformOrigin: "center" }, children });
};
const Shake = ({
  children,
  delay = 0,
  ...
  if (elapsed > duration) return /* @__PURE__ */ jsx("div", { children });
  const t = elapsed / duration;
  const decay = 1 - t;
  const translateX = Math.sin(elapsed * 2.5) * intensity * decay;
  return /* @__PURE__ */ jsx("div", { style: { transform: `translateX(${translateX}px)` }, children });
};
const Tada = ({
  children,
  delay = 0,
  ...
  const frame = (0,esm.useCurrentFrame)();
  if (frame < delay) return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { children });
  const elapsed = frame - delay;
  if (elapsed > duration) return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { children });
  const t = elapsed / duration;
  let scale;
  let rotate;
  if (t < 0.1) {
    scale = (0,esm.interpolate)(t, [0, 0.1], [1, 0.9]);
    rotate = (0,esm.interpolate)(t, [0, 0.1], [0, -3]);
  } else if (t < 0.3) {
    scale = (0,esm.interpolate)(t, [0.1, 0.2], [0.9, 1.1]);
    rotate = Math.sin((t - 0.1) * Math.PI * 15) * 3;
  } else if (t < 0.8) {
    scale = 1.1;
    rotate = Math.sin((t - 0.1) * Math.PI * 10) * 3 * (1 - (t - 0.3) / 0.5);
  } else {
    scale = (0,esm.interpolate)(t, [0.8, 1], [1.1, 1]);
    rotate = 0;
  }
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
...
const Flash = ({
  ...
  return /* @__PURE__ */ jsx("div", { style: { opacity }, children });
};
const GlowPulse = ({
  children,
  delay = 0,
  ...
  if (frame < delay) return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { children });
  const t = (frame - delay) % duration / duration;
  const glowSize = (0,esm.interpolate)(
    Math.sin(t * Math.PI * 2),
    [-1, 1],
    [intensity * 0.3, intensity]
  );
  const glowOpacity = (0,esm.interpolate)(
    Math.sin(t * Math.PI * 2),
    [-1, 1],
    [0.3, 0.8]
  );
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
    ...
    opacity: (0,esm.interpolate)(glowOpacity, [0.3, 0.8], [0.85, 1])
  }, children });
};
const SlideInRotate = ({
  children,
  ...
  const translateX = (0,esm.interpolate)(progress, [0, 1], [distance * dir, 0]);
  const rotate = (0,esm.interpolate)(progress, [0, 1], [angle * dir, 0]);
  const opacity = (0,esm.interpolate)(progress, [0, 0.4], [0, 1], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
    transform: `translateX(${translateX}px) rotate(${rotate}deg)`,
    opacity
...
const PremiumStagger = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: react.Children.map(children, (child, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
    Comp,
    {
      delay: startDelay + index * stagger,
      style,
...
const TaskNode = ({ x, y, size, delay, label, color }) => {
  const frame = (0,esm.useCurrentFrame)();
  const entry = (0,esm.spring)({
    frame: frame - delay,
    fps: 30,
...
function IntroChallenge() {
  ...
  const timelineWidth = (0,esm.spring)({
    frame: frame - 20,
    fps,
    config: SPRING_CONFIGS.stiff
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.background, overflow: "hidden" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, duration: 270, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        style: {
          display: "flex",
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeInUp, { duration: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "h1",
            {
              style: {
                color: COLORS.white,
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeInUp, { delay: 15, duration: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "p",
            {
              style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { pointerEvents: "none" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ZoomIn, { delay: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowPulse, { color: COLORS.secondary, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                width: "100%",
              ...
              children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "svg",
                {
                  ...
                  stroke: "white",
                  strokeWidth: "2",
                  children: /* @__PURE__ */ (0,jsx_runtime.jsx)("path", { d: "M13 2L3 14h9l-1 8 10-12h-9l1-8z" })
                }
              )
            }
          ) }) })
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "NOW" }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "+1 MIN" }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "+1 HOUR" }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: "+1 DAY" })
          ]
        }
      ),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(PremiumStagger, { delayOffset: 60, interval: 2, children: tasks.map((task) => {
        const dropProgress = (0,esm.spring)({
          frame: frame - task.delay,
          fps,
          config: { damping: 10, stiffness: 60 }
        });
        const currentY = (0,esm.interpolate)(dropProgress, [0, 1], [task.y, timelineY - height * 0.02]);
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(
          TaskNode,
          {
            x: task.x,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 180, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeIn, { duration: 45, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
              ...
              children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "span",
                {
                  ...
                  children: [
                    "Scale: ",
                    /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: COLORS.accent }, children: "10^6+" }),
                    " Concurrent Events"
                  ]
                }
              )
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: minDim * 0.04 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(BounceIn, { delay: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 12, height: 12, borderRadius: "50%", background: COLORS.primary } }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: COLORS.text, fontSize: height * 0.015 }, children: "Cache Keys" })
            ] }) }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(BounceIn, { delay: 45, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 12, height: 12, borderRadius: "50%", background: COLORS.secondary } }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: COLORS.text, fontSize: height * 0.015 }, children: "Retry Logic" })
            ] }) })
          ] })
        ]
      }
...
function HeapSortingScene() {
  ...
  const tasks = (0,react.useMemo)(() => {
    return Array.from({ length: 15 }).map((_, i) => ({
      ...
      color: i === 0 ? heap_sorting_COLORS.accent : i % 2 === 0 ? heap_sorting_COLORS.primary : heap_sorting_COLORS.secondary
    }));
  }, [width]);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: heap_sorting_COLORS.background }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(heap_sorting_FadeInDown, { frame, delay: 10, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      paddingTop: height * 0.05,
      textAlign: "center",
      width: "100%"
    }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("h1", { style: {
        color: heap_sorting_COLORS.white,
        fontSize: height * 0.045,
        fontFamily: "sans-serif",
        fontWeight: 800,
        margin: 0
        ...
        "Priority Queue: ",
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: heap_sorting_COLORS.accent }, children: "Binary Heap" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: {
        color: heap_sorting_COLORS.primary,
        fontSize: height * 0.025,
        fontFamily: "monospace",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      ...
      width: "100%",
      height: height * 5e-3,
      background: heap_sorting_COLORS.white,
      opacity: (0,esm.interpolate)(frame, [60, 90], [0.3, 0], { extrapolateRight: "clamp" }),
      left: 0
    } }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", width: "100%", height: "100%", pointerEvents: "none" }, children: tasks.slice(0, 15).map((_, i) => {
      if (i === 0) return null;
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "line",
        {
          x1: start.x,
          y1: start.y,
          x2: (0,esm.interpolate)(lineProgress, [0, 1], [start.x, end.x]),
          y2: (0,esm.interpolate)(lineProgress, [0, 1], [start.y, end.y]),
          stroke: heap_sorting_COLORS.primary,
          strokeWidth: height * 3e-3,
          strokeOpacity: (0,esm.interpolate)(lineProgress, [0, 1], [0, 0.4])
        },
        `edge-${i}`
      );
    }) }),
    tasks.map((task, i) => {
      const flyProgress = (0,esm.spring)({
        frame: frame - (60 + i * 4),
        fps,
        config: { damping: 12, stiffness: 60 }
      });
      const treePos = getTreeNodePos(i);
      const currentX = (0,esm.interpolate)(flyProgress, [0, 1], [task.initialX, treePos.x]);
      const currentY = (0,esm.interpolate)(flyProgress, [0, 1], [height * 0.85, treePos.y]);
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "div",
        {
          style: {
            ...
            height: nodeSize,
            borderRadius: "50%",
            background: flyProgress > 0.8 && isRoot ? heap_sorting_COLORS.accent : task.color,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            boxShadow: isRoot ? `0 0 ${minDim * 0.05}px ${heap_sorting_COLORS.accent}66` : "0 4px 12px rgba(0,0,0,0.3)",
            border: `${minDim * 5e-3}px solid ${heap_sorting_COLORS.white}`,
            zIndex: 10
          },
          children: [
            ...
            isRoot && frame > 120 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", width: "100%", height: "100%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowPulse, { color: heap_sorting_COLORS.accent }) })
          ]
        },
        task.id
      );
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeIn, { frame, delay: 220, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        backgroundColor: "rgba(255,255,255,0.05)",
        padding: `${height * 0.02}px ${width * 0.05}px`,
        borderRadius: minDim * 0.02,
        border: `1px solid ${heap_sorting_COLORS.primary}44`,
        backdropFilter: "blur(10px)",
        maxWidth: "80%"
      }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("p", { style: {
        color: heap_sorting_COLORS.white,
        ...
        "Sorting requires ",
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: heap_sorting_COLORS.accent, fontWeight: "bold" }, children: "re-balancing" }),
        " the tree every time a task is added."
      ] }) }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Sequence, { from: 320, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BounceIn, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        color: heap_sorting_COLORS.secondary,
...
function heap_sorting_FadeInDown({ children, frame, delay = 0 }) {
  const opacity = (0,esm.interpolate)(frame - delay, [0, 20], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const translateY = (0,esm.interpolate)(frame - delay, [0, 20], [-20, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity, transform: `translateY(${translateY}px)` }, children });
}
...
function HeapBottleneck() {
  ...
  const congestion = (0,esm.interpolate)(frame, [congestionStart, 200], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const jitterIntensity = (0,esm.interpolate)(frame, [congestionStart, chaosPeakStart], [0, 1], {
    extrapolateLeft: "clamp"
  });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: heap_bottleneck_COLORS.background }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { height: height * 0.15, top: height * 0.05, textAlign: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BounceIn, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      color: heap_bottleneck_COLORS.white,
      fontSize: height * 0.045,
      fontWeight: 800,
      textShadow: "0 4px 10px rgba(0,0,0,0.5)"
    }, children: "HEAP OVERHEAD BOTTLE NECK" }) }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%", overflow: "visible" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("filter", { id: "glow", x: "-20%", y: "-20%", width: "140%", height: "140%", children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("feGaussianBlur", { stdDeviation: "5", result: "blur" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("feComposite", { in: "SourceGraphic", in2: "blur", operator: "over" })
        ] }) }),
        TREE_CONNECTIONS.map(([parentIdx, childIdx]) => {
          ...
          const lineColor = (0,esm.interpolate)(
            frame,
            [redPhaseStart, 250],
            [0, 1],
            { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
          ...
          return /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "line",
            {
              ...
              x2,
              y2,
              stroke: lineColor > 0.5 ? heap_bottleneck_COLORS.danger : heap_bottleneck_COLORS.primary,
      ...
      TREE_NODES.map((node) => {
        ...
        const redFactor = (0,esm.interpolate)(
          frame,
          [redPhaseStart + node.id * 10, redPhaseStart + 60 + node.id * 10],
          [0, 1],
          { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
        );
        const nodeColor = redFactor > 0.5 ? heap_bottleneck_COLORS.danger : heap_bottleneck_COLORS.primary;
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              border: `${minDim * 5e-3}px solid ${heap_bottleneck_COLORS.white}`,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              boxShadow: redFactor > 0.5 ? `0 0 ${20 * redFactor}px ${heap_bottleneck_COLORS.danger}` : "0 4px 15px rgba(0,0,0,0.3)",
              transition: "background-color 0.2s ease"
            },
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
              width: nodeSize * 0.4,
              height: nodeSize * 0.4,
              background: heap_bottleneck_COLORS.white,
              opacity: 0.3,
              borderRadius: "2px",
      ...
      congestion > 0.5 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        position: "absolute",
        top: treeTop + levelSpacing * 0.5,
        left: width * 0.2,
        right: width * 0.2,
        height: levelSpacing * 2,
        background: `radial-gradient(circle, ${heap_bottleneck_COLORS.danger}22 0%, transparent 70%)`,
        filter: "blur(20px)",
        opacity: (0,esm.interpolate)(frame, [200, 250], [0, 0.4], { extrapolateLeft: "clamp" })
      } })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { top: height * 0.75, height: height * 0.2, display: "flex", flexDirection: "column", alignItems: "center", gap: minDim * 0.02 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeInUp, { delay: 60, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        fontSize: height * 0.08,
        fontWeight: 900,
        color: heap_bottleneck_COLORS.danger,
        fontFamily: "monospace",
        backgroundColor: "rgba(0,0,0,0.4)",
        padding: `${height * 0.01}px ${width * 0.05}px`,
        borderRadius: minDim * 0.02,
        border: `${minDim * 5e-3}px solid ${heap_bottleneck_COLORS.danger}`,
        boxShadow: `0 0 40px ${heap_bottleneck_COLORS.danger}44`
      }, children: "O(log N)" }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowPulse, { speed: "fast", children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        fontSize: height * 0.025,
        color: heap_bottleneck_COLORS.white,
        fontWeight: 500,
        opacity: (0,esm.interpolate)(frame, [100, 130], [0, 1], { extrapolateLeft: "clamp" }),
        textAlign: "center",
        maxWidth: "80%"
    ...
    Array.from({ length: 12 }).map((_, i) => {
      const tDelay = i * 20;
      const progress = (0,esm.interpolate)((frame - tDelay) % 60, [0, 60], [0, 1]);
      const startX = i * 0.15 * width % width;
      const currentY = (0,esm.interpolate)(progress, [0, 1], [-100, treeTop]);
      ...
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            ...
            width: minDim * 0.03,
            height: minDim * 0.03,
            backgroundColor: heap_bottleneck_COLORS.accent,
            borderRadius: "2px",
            opacity,
            boxShadow: `0 0 10px ${heap_bottleneck_COLORS.accent}`,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      position: "absolute",
      inset: 0,
      backgroundColor: heap_bottleneck_COLORS.danger,
...
const timing_wheel_intro_COLORS = {
  background: "#0F172A",
  primary: "#3B82F6",
  secondary: "#10B981",
  accent: "#F59E0B",
...
const TreeToCircle = () => {
  ...
  const morphProgress = (0,esm.spring)({
  ...
  const logNLabelOpacity = (0,esm.interpolate)(
    frame,
    [startMorphFrame, startMorphFrame + 20],
    [1, 0]
  );
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: timing_wheel_intro_COLORS.background }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "div",
      {
        style: {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, duration: startMorphFrame + 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                color: timing_wheel_intro_COLORS.error,
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: startMorphFrame + 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BounceIn, { delay: 0, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                color: timing_wheel_intro_COLORS.secondary,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
        ...
        "svg",
        {
          ...
          children: [
            morphProgress < 0.9 && [
              ...
              const child = nodes[c];
              const lineOpacity = (0,esm.interpolate)(morphProgress, [0, 0.5], [0.6, 0]);
              return /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "line",
                {
                  x1: parent.x * width,
                  ...
                  x2: child.x * width,
                  y2: child.y * height,
                  stroke: timing_wheel_intro_COLORS.error,
            ...
            Array.from({ length: 60 }).map((_, i) => {
              ...
              const segmentScale = (0,esm.spring)({
              ...
              return /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "rect",
                {
                  ...
                  height: minDim * 0.04,
                  rx: minDim * 5e-3,
                  fill: timing_wheel_intro_COLORS.primary,
            ...
            frame > pointerAppearFrame && /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "line",
                {
                  x1: centerX,
                  ...
                  stroke: timing_wheel_intro_COLORS.accent,
                  strokeWidth: minDim * 0.015,
                  strokeLinecap: "round",
                  transform: `rotate(${(frame - pointerAppearFrame) * 2}, ${centerX}, ${centerY})`
                }
              ),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: centerX, cy: centerY, r: minDim * 0.02, fill: timing_wheel_intro_COLORS.accent })
            ] })
          ]
        }
      ),
      nodes.map((node, i) => {
        ...
        const currentX = (0,esm.interpolate)(
          morphProgress,
          [0, 1],
          [node.x * width, targetX]
        );
        const currentY = (0,esm.interpolate)(
          morphProgress,
          [0, 1],
          [node.y * height, targetY]
        );
        const nodeColor = (0,esm.interpolate)(
          morphProgress,
          [0, 0.8],
          [0, 1]
        ) > 0.5 ? timing_wheel_intro_COLORS.secondary : timing_wheel_intro_COLORS.error;
        ...
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              justifyContent: "center",
              zIndex: 10,
              opacity: (0,esm.interpolate)(morphProgress, [0.8, 1], [1, 0])
            },
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: "white", fontWeight: "bold", fontSize: minDim * 0.02 }, children: i })
          },
          `node-${i}`
        );
      })
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PremiumStagger, { speed: "fast", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeIn, { delay: 0, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              ...
              {
                style: {
                  color: timing_wheel_intro_COLORS.text,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 200, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowPulse, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
          ...
          height: minDim * 0.8,
          borderRadius: "50%",
          border: `2px solid ${timing_wheel_intro_COLORS.secondary}22`,
          pointerEvents: "none"
        }
      }
    ) }) })
...
/* harmony default export */ const timing_wheel_intro = (TreeToCircle);
...
const TimingWheelScene = () => {
  ...
  const rotation = (0,esm.interpolate)(frame, [0, 240], [0, 360]);
  const taskFlyProgress = (0,esm.spring)({
    frame: frame - 30,
    fps,
    config: SPRING_CONFIGS.gentle
  });
  ...
  const taskX = (0,esm.interpolate)(taskFlyProgress, [0, 1], [width * 0.8, bucketX]);
  const taskY = (0,esm.interpolate)(taskFlyProgress, [0, 1], [height * 0.2, bucketY]);
  const taskScale = (0,esm.interpolate)(taskFlyProgress, [0, 1], [0.5, 1]);
  const isPointerAtBucket = frame > 95 && frame < 115;
  const bucketHighlight = (0,esm.spring)({
    frame: frame - 95,
    fps,
    config: SPRING_CONFIGS.stiff
  });
  const executeProgress = (0,esm.spring)({
    frame: frame - 110,
    fps,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: colors.background }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      position: "absolute",
      top: height * 0.05,
      width: "100%",
      textAlign: "center",
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)(BounceIn, { delay: 10, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { style: {
        fontSize: height * 0.045,
        color: colors.white,
        margin: 0,
        fontWeight: 800,
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeIn, { delay: 40, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "circle",
          {
            cx: centerX,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: centerX, cy: centerY, r: 8, fill: colors.accent })
      ] }),
      frame >= 30 && frame < 125 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        position: "absolute",
        ...
        zIndex: 10
      }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: "white", fontWeight: "bold", fontSize: taskSize * 0.4 }, children: "5s" }) }),
      frame >= 110 && frame < 150 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        position: "absolute",
        left: bucketX,
        top: bucketY,
        transform: "translate(-50%, -50%)"
      }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Tada, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        width: minDim * 0.2,
        height: minDim * 0.2,
        borderRadius: "50%",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { top: height * 0.75, height: height * 0.25, justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(PremiumStagger, { delayPerItem: 30, startDelay: 100, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: width * 0.8 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        background: "rgba(255, 255, 255, 0.05)",
        backdropFilter: "blur(10px)",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: colors.accent, fontWeight: 800 }, children: "No Sorting Required:" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("br", {}),
        "Task maps directly to ",
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: colors.secondary }, children: "Index [5]" })
      ] }) }) }, "label1"),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { marginTop: minDim * 0.03 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowPulse, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
...
/* harmony default export */ const direct_insertion = (TimingWheelScene);
...
const hierarchy_expansion_COLORS = {
  background: "#0F172A",
  inner: "#3B82F6",
  // Blue
  middle: "#10B981",
...
function HierarchyExpansion() {
  ...
  const cameraScale = (0,esm.interpolate)(zoom, [0, 1], [1.2, 0.45]);
  const containerTranslateY = (0,esm.interpolate)(zoom, [0, 1], [0, -height * 0.05]);
  const middleReveal = (0,esm.spring)({
    frame: frame - middleWheelStart,
    fps,
    config: { damping: 15, stiffness: 100 }
  });
  const outerReveal = (0,esm.spring)({
  ...
  const renderHand = (radius, rotation, color) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { transform: `rotate(${rotation}, ${width / 2}, ${height / 2})`, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "line",
      {
        x1: width / 2,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: hierarchy_expansion_COLORS.background }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      position: "absolute",
      top: height * 0.05,
      width: "100%",
      ...
      alignItems: "center",
      gap: minDim * 0.02
    }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeIn, { delay: 10, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { style: {
      color: hierarchy_expansion_COLORS.text,
      fontSize: height * 0.045,
      fontWeight: 800,
      margin: 0,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      ...
      position: "relative"
    }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width, height, viewBox: `0 0 ${width} ${height}`, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("radialGradient", { id: "innerGlow", cx: "50%", cy: "50%", r: "50%", children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "0%", stopColor: hierarchy_expansion_COLORS.inner, stopOpacity: "0.2" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "100%", stopColor: hierarchy_expansion_COLORS.inner, stopOpacity: "0" })
      ] }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: width / 2, cy: height / 2, r: innerRadius * 1.5, fill: "url(#innerGlow)" }),
      renderWheel(innerRadius, hierarchy_expansion_COLORS.inner, 1, 60),
      renderWheel(middleRadius, hierarchy_expansion_COLORS.middle, middleReveal, 60),
      renderWheel(outerRadius, hierarchy_expansion_COLORS.outer, outerReveal, 60),
      renderHand(innerRadius, rotationInner, hierarchy_expansion_COLORS.inner),
      middleReveal > 0 && renderHand(middleRadius, rotationMiddle, hierarchy_expansion_COLORS.middle),
      outerReveal > 0 && renderHand(outerRadius, rotationOuter, hierarchy_expansion_COLORS.outer),
      tasks.map((task) => {
        let radius = innerRadius;
        let opacity = 1;
        let color = hierarchy_expansion_COLORS.inner;
        if (task.wheel === "middle") {
          radius = middleRadius;
          opacity = middleReveal;
          color = hierarchy_expansion_COLORS.middle;
        } else if (task.wheel === "outer") {
          radius = outerRadius;
          opacity = outerReveal;
          color = hierarchy_expansion_COLORS.outer;
        }
        const driftProgress = (0,esm.spring)({
          frame: frame - taskDriftStart - task.id * 10,
          fps,
          config: { damping: 12 }
        });
        const currentRadius = (0,esm.interpolate)(driftProgress, [0, 1], [radius, radius * 0.85]);
        ...
        return /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { opacity, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "rect",
            {
              ...
              width: 20,
              height: 20,
              fill: hierarchy_expansion_COLORS.task,
              rx: 4,
              transform: `rotate(${task.angle}, ${taskX}, ${taskY})`
            }
          ),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: taskX, cy: taskY, r: 15, fill: "none", stroke: color, strokeWidth: 2, opacity: driftProgress })
        ] }, task.id);
      })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      ...
      justifyContent: "center",
      padding: `0 ${width * 0.1}px`
    }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(PremiumStagger, { startDelay: 100, delayPerItem: 40, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      display: "flex",
      gap: minDim * 0.04,
      background: "rgba(255,255,255,0.05)",
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: hierarchy_expansion_COLORS.inner, fontWeight: "bold" }, children: "Seconds" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        color: hierarchy_expansion_COLORS.middle,
        fontWeight: "bold",
        opacity: (0,esm.interpolate)(frame, [middleWheelStart, middleWheelStart + 20], [0, 1])
      }, children: "Minutes" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        color: hierarchy_expansion_COLORS.outer,
        fontWeight: "bold",
        opacity: (0,esm.interpolate)(frame, [outerWheelStart, outerWheelStart + 20], [0, 1])
      }, children: "Hours" })
    ] }) }) }),
    frame > 280 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      position: "absolute",
      bottom: height * 0.25,
      left: "50%",
      transform: "translateX(-50%)"
    }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowPulse, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      background: hierarchy_expansion_COLORS.middle,
      color: hierarchy_expansion_COLORS.background,
...
const WheelRing = ({
  ...
  const minDim = Math.min((0,esm.useVideoConfig)().width, height);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { style: { transform: `rotate(${rotation - 90}deg)`, transformOrigin: "center" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: "50%",
        ...
        r: radius,
        fill: "none",
        stroke: the_cascade_COLORS.ring,
        strokeWidth
      }
    ),
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "line",
      {
        ...
        stroke: the_cascade_COLORS.accent,
        strokeWidth: 4,
        strokeLinecap: "round"
      }
    ),
...
function HierarchicalCascade() {
  ...
  const cascades = cascadeTriggers.map((trigger) => {
    const progress = (0,esm.interpolate)(frame, [trigger, trigger + 45], [0, 1], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: the_cascade_COLORS.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      position: "absolute",
      top: height * 0.05,
      width: "100%",
      textAlign: "center"
    }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(FadeIn, { delay: 10, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { style: {
        color: the_cascade_COLORS.white,
        fontSize: height * 0.04,
        margin: 0,
        fontFamily: "sans-serif"
      }, children: "Hierarchical Cascade" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: { color: the_cascade_COLORS.primary, fontSize: height * 0.02, marginTop: height * 0.01 }, children: "O(1) Scheduling Across Time Scales" })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "relative", width: "100%", height: height * 0.6 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width: "100%", height: "100%", viewBox: `0 0 ${width} ${height * 0.6}`, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "circle",
          {
            cx: "50%",
            cy: "50%",
            r: minDim * 0.04,
            fill: the_cascade_COLORS.bg,
            stroke: the_cascade_COLORS.secondary,
            strokeWidth: 3
          }
        ),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "text",
          {
            x: "50%",
            y: "50%",
            fill: the_cascade_COLORS.secondary,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(WheelRing, { radius: rSeconds, strokeWidth: ringWidth, label: "SECONDS", rotation: secRotation }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(WheelRing, { radius: rMinutes, strokeWidth: ringWidth, label: "MINUTES", rotation: minRotation }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(WheelRing, { radius: rHours, strokeWidth: ringWidth, label: "HOURS", rotation: hourRotation }),
        cascadeTriggers.map((trigger, idx) => {
          ...
          const endR = rSeconds;
          const currentR = (0,esm.interpolate)(progress, [0, 1], [startR, endR]);
          ...
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "rect",
              {
                ...
                height: 20,
                rx: 4,
                fill: the_cascade_COLORS.accent,
                style: { opacity: (0,esm.interpolate)(progress, [0, 0.1, 0.9, 1], [0, 1, 1, 0.8]) }
              }
            ),
            progress > 0.8 && /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: x, cy: y, r: (0,esm.interpolate)(progress, [0.8, 1], [0, 40]), fill: "none", stroke: the_cascade_COLORS.accent, strokeWidth: 2, style: { opacity: 1 - progress } })
          ] }, `cascade-${trigger}`);
        }),
        Array.from({ length: 5 }).map((_, i) => {
          const taskAngle = i * 72;
          const isHit = Math.abs(secRotation - taskAngle) < 10;
          const opacity = (0,esm.interpolate)(frame % 300, [0, 250], [1, 1]);
          ...
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "rect",
              {
                ...
                height: 16,
                rx: 2,
                fill: isHit ? the_cascade_COLORS.secondary : the_cascade_COLORS.primary,
                style: { opacity }
              }
            ),
            isHit && /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "line",
              {
                x1: x,
                y1: y,
      ...
      secRotation % 72 < 5 && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { pointerEvents: "none", justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowPulse, { color: the_cascade_COLORS.secondary, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        width: minDim * 0.1,
        height: minDim * 0.1,
        borderRadius: "50%",
        border: `2px solid ${the_cascade_COLORS.secondary}`
      } }) }) })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      position: "absolute",
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: minDim * 0.02 }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 15, height: 15, backgroundColor: the_cascade_COLORS.accent, borderRadius: 3 } }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: the_cascade_COLORS.white, fontSize: height * 0.02, fontFamily: "sans-serif" }, children: 'Tasks "Cascade" from outer wheels on every tick' })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: minDim * 0.02 }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 15, height: 15, backgroundColor: the_cascade_COLORS.secondary, borderRadius: 3 } }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: the_cascade_COLORS.white, fontSize: height * 0.02, fontFamily: "sans-serif" }, children: "Inner wheel handles sub-second execution" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: minDim * 0.02 }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 15, height: 15, border: `2px solid ${the_cascade_COLORS.accent}`, borderRadius: "50%" } }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: the_cascade_COLORS.white, fontSize: height * 0.02, fontFamily: "sans-serif" }, children: "O(1) constant time: No sorting required" })
      ] })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      position: "absolute",
      ...
      height: "100%",
      backgroundColor: the_cascade_COLORS.primary,
      boxShadow: `0 0 10px ${the_cascade_COLORS.primary}`,
      borderRadius: 2
    } }) })
  ] });
}
...
const KafkaLogo = ({ size, color }) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { viewBox: "0 0 24 24", width: size, height: size, fill: color, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("path", { d: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" }) });
const NettyLogo = ({ size }) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { viewBox: "0 0 100 100", width: size, height: size, children: [
  /* @__PURE__ */ (0,jsx_runtime.jsx)("path", { d: "M20,50 L50,20 L80,50 L50,80 Z", fill: "none", stroke: real_world_usage_COLORS.netty, strokeWidth: "6" }),
  /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: "50", cy: "50", r: "15", fill: real_world_usage_COLORS.netty })
] });
const HierarchicalTimingWheelFinal = () => {
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const frame = (0,esm.useCurrentFrame)();
  const minDim = Math.min(width, height);
  ...
  const uiIn = (0,esm.spring)({
    frame: frame - uiEvolutionStart,
    fps,
    config: { damping: 15 }
  });
  const wheels = [
    { radius: minDim * 0.4, speed: 1, label: "HOURS", color: real_world_usage_COLORS.accent },
    { radius: minDim * 0.28, speed: 12, label: "MINUTES", color: real_world_usage_COLORS.primary },
    { radius: minDim * 0.16, speed: 60, label: "SECONDS", color: real_world_usage_COLORS.secondary }
  ];
  const tasks = (0,react.useMemo)(() => {
  ...
  const centerX = width / 2;
  const centerY = height * 0.45;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: real_world_usage_COLORS.background, color: real_world_usage_COLORS.white, fontFamily: "sans-serif" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      position: "absolute",
      top: height * 0.05,
      width: "100%",
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeIn, { duration: 30, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { style: {
        fontSize: minDim * 0.07,
        fontWeight: 800,
        margin: 0,
        letterSpacing: "-0.02em",
        background: `linear-gradient(to right, ${real_world_usage_COLORS.primary}, ${real_world_usage_COLORS.secondary})`,
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(KafkaLogo, { size: minDim * 0.06, color: real_world_usage_COLORS.kafka }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: minDim * 0.035, fontWeight: 600 }, children: "Apache Kafka" })
        ] }),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(NettyLogo, { size: minDim * 0.06 }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: minDim * 0.035, fontWeight: 600 }, children: "Netty" })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width, height, style: { overflow: "visible" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("defs", { children: [
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("filter", { id: "glow", x: "-20%", y: "-20%", width: "140%", height: "140%", children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("feGaussianBlur", { stdDeviation: "5", result: "blur" }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("feComposite", { in: "SourceGraphic", in2: "blur", operator: "over" })
          ] }),
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("linearGradient", { id: "wheelGrad", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "0%", stopColor: real_world_usage_COLORS.primary, stopOpacity: "0.2" }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "100%", stopColor: real_world_usage_COLORS.secondary, stopOpacity: "0.05" })
          ] })
        ] }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowPulse, { color: real_world_usage_COLORS.secondary, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "circle",
          {
            cx: centerX,
            cy: centerY,
            r: minDim * 0.05,
            fill: real_world_usage_COLORS.secondary,
            fillOpacity: 0.2,
            stroke: real_world_usage_COLORS.secondary,
            strokeWidth: 3
          }
        ) }),
        wheels.map((wheel, i) => {
          const rotation = rotationBase * wheel.speed;
          const glassBorderOpacity = (0,esm.interpolate)(uiIn, [0, 1], [0.1, 0.4]);
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "circle",
              {
      ...
      wheels.map((wheel, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        position: "absolute",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 150, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      position: "absolute",
      bottom: height * 0.1,
      width: "100%",
      display: "flex",
      justifyContent: "center",
      gap: minDim * 0.04
    }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(PremiumStagger, { speed: "fast", children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        background: "rgba(255, 255, 255, 0.05)",
        backdropFilter: "blur(10px)",
        padding: `${minDim * 0.02}px ${minDim * 0.04}px`,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: real_world_usage_COLORS.text, fontSize: minDim * 0.025, marginBottom: 5 }, children: "COMPLEXITY" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: real_world_usage_COLORS.secondary, fontSize: minDim * 0.05, fontWeight: "bold" }, children: "O(1)" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        background: "rgba(255, 255, 255, 0.05)",
        backdropFilter: "blur(10px)",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: real_world_usage_COLORS.text, fontSize: minDim * 0.025, marginBottom: 5 }, children: "MEMORY" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: real_world_usage_COLORS.primary, fontSize: minDim * 0.05, fontWeight: "bold" }, children: "CONSTANT" })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
        background: "rgba(255, 255, 255, 0.05)",
        backdropFilter: "blur(10px)",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: real_world_usage_COLORS.text, fontSize: minDim * 0.025, marginBottom: 5 }, children: "LOCKING" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: real_world_usage_COLORS.accent, fontSize: minDim * 0.05, fontWeight: "bold" }, children: "MINIMAL" })
      ] })
    ] }) }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.Sequence, { from: 400, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        position: "absolute",
        bottom: height * 0.3,
        width: "100%",
        textAlign: "center"
      }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BounceIn, { delay: 20, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        display: "inline-block",
        padding: "10px 30px",
        borderRadius: 100,
        backgroundColor: real_world_usage_COLORS.secondary,
        color: "#000",
        fontWeight: 900,
        fontSize: minDim * 0.04,
        boxShadow: `0 0 40px ${real_world_usage_COLORS.secondary}44`
      }, children: "READY FOR MILLIONS OF TASKS/S" }) }) }),
      frame > 450 && frame % 30 < 15 && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { border: `10px solid ${real_world_usage_COLORS.secondary}`, opacity: 0.1 } })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      position: "absolute",
      bottom: height * 0.03,
      width: "100%",
      textAlign: "center",
      color: real_world_usage_COLORS.text,
...
/* harmony default export */ const real_world_usage = (HierarchicalTimingWheelFinal);
...
function Main() {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { background: "#0F172A" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 270, name: "intro_challenge", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(IntroChallenge, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 270, durationInFrames: 420, name: "heap_sorting", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(HeapSortingScene, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 690, durationInFrames: 330, name: "heap_bottleneck", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(HeapBottleneck, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1020, durationInFrames: 330, name: "timing_wheel_intro", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(timing_wheel_intro, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1350, durationInFrames: 240, name: "direct_insertion", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(direct_insertion, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1590, durationInFrames: 330, name: "hierarchy_expansion", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(HierarchyExpansion, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1920, durationInFrames: 1620, name: "the_cascade", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(HierarchicalCascade, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 3540, durationInFrames: 600, name: "real_world_usage", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(real_world_usage, {}) })
  ] });
}
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: "proj-b69c7daf-56ec-4a4a-9b0c-b49e81302941",
      component: Main,
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "openhands-sandbox:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkopenhands_sandbox"] = self["webpackChunkopenhands_sandbox"] || [];
