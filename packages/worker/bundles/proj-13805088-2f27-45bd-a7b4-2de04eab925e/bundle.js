...
const ReservoirSamplingScene = () => {
  ...
  const slotScale = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 10, stiffness: 100 }
  });
  const tokenFlowPosition = (0,esm.interpolate)(
    frame,
    [0, 240],
    [tokenFlowStartX, tokenFlowEndX],
    { extrapolateRight: "clamp" }
  );
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#ecf0f1" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "svg",
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: "50%", cy: "50%", r: "45%", fill: "#3498db" })
      }
    ),
    Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "svg",
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: "50%", cy: "50%", r: "45%", fill: "#2ecc71" })
      },
      i
    )),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "svg",
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: "50%", cy: "50%", r: "45%", fill: "#e74c3c" })
      }
    )
  ] });
};
/* harmony default export */ const scene_1 = (ReservoirSamplingScene);

;// ./src/proj_13805088_2f27_45bd_a7b4_2de04eab925e/scenes/scene_2.tsx



const scene_2_ReservoirSamplingScene = () => {
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const frame = (0,esm.useCurrentFrame)();
  ...
  const diceOpacity = (0,esm.interpolate)(frame % 30, [0, 15, 30], [0, 1, 0]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#ecf0f1" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "rect",
      {
        x: winnerSlotX,
    ...
    Array.from({ length: numberOfTokens }).map((_, i) => {
      const tokenX = (0,esm.interpolate)(
        frame - i * 30,
        [0, 90],
...
/* harmony default export */ const scene_2 = (scene_2_ReservoirSamplingScene);

;// ./src/proj_13805088_2f27_45bd_a7b4_2de04eab925e/scenes/scene_3.tsx



const scene_3_ReservoirSamplingScene = () => {
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const frame = (0,esm.useCurrentFrame)();
  const slotSize = width * 0.15;
  const tokenSize = width * 0.05;
  ...
  const tokenProgress = (0,esm.interpolate)(frame, [0, 120], [0, 1], { extrapolateRight: "clamp" });
  const tokenX = (0,esm.interpolate)(tokenProgress, [0, 1], [tokenStartX, slotX + slotSize / 2 - tokenSize / 2]);
  const diceRotation = (0,esm.spring)({
    frame: frame - 60,
    fps,
    config: { damping: 10, stiffness: 100 }
  }) * 360;
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#ecf0f1", justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "rect",
      {
        x: slotX,
    ...
    tokenVisible && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: tokenX,
        cy: slotY + slotSize / 2,
    ...
    diceVisible && /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { transform: `translate(${diceX}, ${diceY}) rotate(${diceRotation})`, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "rect",
        {
          x: -diceSize / 2,
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: 0, cy: 0, r: tokenSize * 0.2, fill: "#ecf0f1" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: -tokenSize * 0.3, cy: -tokenSize * 0.3, r: tokenSize * 0.2, fill: "#ecf0f1" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: tokenSize * 0.3, cy: tokenSize * 0.3, r: tokenSize * 0.2, fill: "#ecf0f1" })
    ] })
  ] }) });
};
/* harmony default export */ const scene_3 = (scene_3_ReservoirSamplingScene);

;// ./src/proj_13805088_2f27_45bd_a7b4_2de04eab925e/scenes/scene_4.tsx



const scene_4_ReservoirSamplingScene = () => {
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const frame = (0,esm.useCurrentFrame)();
  const slotSize = width * 0.15;
  const tokenSize = width * 0.05;
  ...
  const tokenX = (0,esm.interpolate)(tokenProgress, [0, 1], [streamStartX, streamEndX]);
  const diceRoll = (0,esm.spring)({
    frame: frame % 60,
    fps,
    config: { damping: 10, stiffness: 100 }
  });
  const diceRotation = (0,esm.interpolate)(diceRoll, [0, 1], [0, 360 * 2]);
  const winnerReplacementFrame = 240;
  const winningTokenProgress = (0,esm.interpolate)(
    frame,
    [winnerReplacementFrame, winnerReplacementFrame + 30],
    [0, 1],
    { extrapolateRight: "clamp" }
  );
  const winningTokenY = (0,esm.interpolate)(winningTokenProgress, [0, 1], [streamY, currentWinnerY]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#ecf0f1", justifyContent: "center", alignItems: "center" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", top: streamY, left: tokenX }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: tokenSize / 2, cy: tokenSize / 2, r: tokenSize / 2, fill: "#2ecc71" }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { width: diceSize, height: diceSize, fill: "#e74c3c", rx: "15%" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: diceSize * 0.25, cy: diceSize * 0.25, r: diceSize * 0.05, fill: "#ffffff" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: diceSize * 0.75, cy: diceSize * 0.25, r: diceSize * 0.05, fill: "#ffffff" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: diceSize * 0.5, cy: diceSize * 0.5, r: diceSize * 0.05, fill: "#ffffff" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: diceSize * 0.25, cy: diceSize * 0.75, r: diceSize * 0.05, fill: "#ffffff" }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: diceSize * 0.75, cy: diceSize * 0.75, r: diceSize * 0.05, fill: "#ffffff" })
        ]
      }
    ),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "svg",
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: tokenSize / 2, cy: tokenSize / 2, r: tokenSize / 2, fill: "#2ecc71" })
      }
    )
  ] });
};
/* harmony default export */ const scene_4 = (scene_4_ReservoirSamplingScene);

;// ./src/proj_13805088_2f27_45bd_a7b4_2de04eab925e/scenes/scene_5.tsx



const scene_5_ReservoirSamplingScene = () => {
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const frame = (0,esm.useCurrentFrame)();
  const tokenSize = width * 0.05;
  ...
  const tokenFlowX = (0,esm.interpolate)(frame, [0, 299], [0, width * 0.6], { extrapolateRight: "clamp" });
  const tokenFlowY = height * 0.4;
  const diceHighlight = (0,esm.interpolate)(frame % 60, [0, 30, 59], [0, 1, 0]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#ecf0f1" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", left: slotX, top: slotY }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "rect",
      {
        x: 0,
        y: 0,
    ...
    [...Array(10)].map((_, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", left: tokenFlowX - i * tokenSize, top: tokenFlowY }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: tokenSize / 2,
        cy: tokenSize / 2,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", left: diceX, top: diceY }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "rect",
        {
          x: 0,
...
/* harmony default export */ const scene_5 = (scene_5_ReservoirSamplingScene);

;// ./src/proj_13805088_2f27_45bd_a7b4_2de04eab925e/scenes/scene_6.tsx



const scene_6_ReservoirSamplingScene = () => {
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const frame = (0,esm.useCurrentFrame)();
  const tokenSize = width * 0.05;
  const slotSize = width * 0.1;
  const numSlots = 5;
  const tokenFlow = (0,esm.interpolate)(frame, [0, 100, 570], [-tokenSize, width * 0.5, width * 1.2]);
  const diceRoll = Math.floor((0,esm.interpolate)(frame % 50, [0, 25, 50], [1, 6, 1]));
  const filledSlotIndex = Math.floor((0,esm.interpolate)(frame, [100, 570], [0, numSlots]));
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#ecf0f1", justifyContent: "center", alignItems: "center" }, children: [
    ...
    Array.from({ length: numSlots }).map((_, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "text",
          {
            x: "50%",
            y: "50%",
...
/* harmony default export */ const scene_6 = (scene_6_ReservoirSamplingScene);

;// ./src/proj_13805088_2f27_45bd_a7b4_2de04eab925e/scenes/scene_7.tsx



const scene_7_ReservoirSamplingScene = () => {
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const frame = (0,esm.useCurrentFrame)();
  const tokenSize = width * 0.05;
  const slotSize = width * 0.1;
  ...
  const zoomOutProgress = (0,esm.spring)({
    frame,
    fps,
    config: {
      damping: 20,
  ...
  const tokenX = (0,esm.interpolate)(frame, [0, 60], [width, -tokenSize * 2], { extrapolateRight: "clamp" });
  const diceRoll = Math.floor(frame / 20 % 6) + 1;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#ecf0f1", overflow: "hidden" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "rect",
      {
        x: (width - slotSize) / 2,
        y: (height - slotSize) / 2,
...
/* harmony default export */ const scene_7 = (scene_7_ReservoirSamplingScene);
...
function Main() {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { background: "#ecf0f1" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 240, name: "scene_1", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_1, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 240, durationInFrames: 210, name: "scene_2", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_2, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 450, durationInFrames: 360, name: "scene_3", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_3, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 810, durationInFrames: 480, name: "scene_4", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_4, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1290, durationInFrames: 300, name: "scene_5", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_5, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1590, durationInFrames: 570, name: "scene_6", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_6, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 2160, durationInFrames: 172, name: "scene_7", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_7, {}) })
  ] });
}
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: "proj-13805088-2f27-45bd-a7b4-2de04eab925e",
      component: Main,
