...
const FloatingParticles = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: Array.from({ length: count }).map((_, i) => {
    const seed = i * 137;
...
const Scene1Content = () => {
  ...
  const activationProgress = frame >= keyFrame ? (0,esm.spring)({ frame: frame - keyFrame, fps, config: SPRING_CONFIG }) : 0;
  const upperScale = (0,esm.interpolate)(activationProgress, [0, 1], [1, 1.1], { extrapolateRight: "clamp" });
  const glowIntensity = (0,esm.interpolate)(activationProgress, [0, 1], [0, 1], { extrapolateRight: "clamp" });
  const textScale = frame >= keyFrame ? (0,esm.spring)({ frame: frame - keyFrame, fps, config: { ...SPRING_CONFIG, damping: 20 } }) : 0;
  const textOpacity = (0,esm.interpolate)(activationProgress, [0, 1], [0, 1], { extrapolateRight: "clamp" });
...
const ConnectingBeam = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, height } = (0,esm.useVideoConfig)();
  const beamProgress = (0,esm.interpolate)(frame, [0, 2], [0, 1], { extrapolateRight: "clamp" });
...
const Scene2Content = () => {
  ...
  const glowIntensity = (0,esm.interpolate)(frame, [0, 1], [0.8, 1], { extrapolateRight: "clamp" });
  const ampersandOpacity = (0,esm.interpolate)(frame, [0, 1], [0, 1], { extrapolateRight: "clamp" });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(ConnectingBeam, {}, "beam-s2"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      FloatingParticles,
      {
...
const Scene3Content = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, height } = (0,esm.useVideoConfig)();
  const activationProgress = (0,esm.spring)({ frame, fps, config: SPRING_CONFIG });
  const lowerScale = (0,esm.interpolate)(activationProgress, [0, 1], [1, 1.1], { extrapolateRight: "clamp" });
  const upperDim = (0,esm.interpolate)(frame, [0, 10], [0.8, 0.2], { extrapolateRight: "clamp" });
  const glowIntensity = (0,esm.interpolate)(activationProgress, [0, 1], [0, 0.8], { extrapolateRight: "clamp" });
  const textScale = (0,esm.spring)({ frame, fps, config: { ...SPRING_CONFIG, mass: 1.2, damping: 25 } });
  const textOpacity = (0,esm.interpolate)(activationProgress, [0, 1], [0, 1], { extrapolateRight: "clamp" });
...
const MainComposition = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.dark }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(AnimatedBackground, {}, "bg"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 51, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene1Content, {}) }, "scene1"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 51, durationInFrames: 3, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene2Content, {}) }, "scene2"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 54, durationInFrames: 19, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene3Content, {}) }, "scene3")
  ] });
};
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
...
/* harmony default export */ const proj_16a40972_8dab_47fc_b1ea_d950f04c0cdc = ((/* unused pure expression or super */ null && (MainComposition)));
