...
const ReservoirSamplingVisualization = () => {
  ...
  const fishPositions = Array.from({ length: numFish }).map((_, i) => ({
    x: (0,esm.interpolate)(frame + i * 30, [0, 240], [-fishWidth, width + fishWidth]),
    y: riverHeight * 0.6
  }));
  const fishColors = ["#007acc", "#ffcc00", "#ff5733", "#50c878", "#de3163"];
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#f0f0f0" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
    ...
    fishPositions.map((pos, index) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { style: { transform: `translate(${pos.x}px, ${pos.y}px)` }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "ellipse",
        {
          cx: fishWidth * 0.5,
...
/* harmony default export */ const scene_1 = (ReservoirSamplingVisualization);
...
const ReservoirSamplingScene = () => {
  ...
  const netPosition = (0,esm.interpolate)(frame, [0, 209], [0, width]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { background: "#f0f0f0" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: 0, y: height * 0.2, width, height: riverHeight, fill: "#007acc" }),
    fishPositions.map(({ x, y }, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: x,
        cy: height * 0.2 + y,
...
/* harmony default export */ const scene_2 = (ReservoirSamplingScene);
...
const scene_3_ReservoirSamplingScene = () => {
  ...
  const fishPositions = Array.from({ length: 10 }, (_, i) => ({
    x: (0,esm.interpolate)(frame, [0, 359], [0, riverWidth - fishSize], { extrapolateRight: "clamp" }) - i * (fishSize * 1.5),
    y: height * 0.5 + Math.sin(frame / 30 + i) * 10,
    color: `hsl(${i * 36 % 360}, 70%, 60%)`
  }));
  const netProgress = (0,esm.spring)({ frame: frame - 60, fps, config: { damping: 8, stiffness: 200 } });
  const netY = (0,esm.interpolate)(netProgress, [0, 1], [height, height * 0.5]);
  const caughtFishIndex = Math.floor((0,esm.interpolate)(frame, [0, 359], [0, 10]) % 10);
  const caughtFish = fishPositions[caughtFishIndex];
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { background: "#f0f0f0", justifyContent: "center", alignItems: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: width * 0.1, y: height * 0.45, width: riverWidth, height: height * 0.1, fill: "#007acc" }),
    fishPositions.map((fish, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: fish.x,
        cy: fish.y,
...
const scene_4_ReservoirSamplingScene = () => {
  ...
  const netCatchProgress = (0,esm.interpolate)(frame, [0, 60, 119], [0, 1, 0], {
    extrapolateRight: "clamp"
  });
  const diceRoll = Math.round(
    (0,esm.interpolate)(frame, [0, 60], [1, 6], {
      extrapolateLeft: "clamp"
    })
  );
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#f0f0f0" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: 0, y: riverY, width, height: height * 0.1, fill: "#007acc" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: fishX,
...
const scene_5_ReservoirSamplingScene = () => {
  ...
  const netX = (0,esm.interpolate)(frame, [0, 660], [width * 0.2, width * 0.8], {
    extrapolateRight: "clamp"
  });
  const fishPositions = Array.from({ length: 10 }, (_, i) => ({
    x: (0,esm.interpolate)(frame, [0, 660], [width + fishSize, -fishSize], {
      extrapolateRight: "clamp"
    }) - i * width * 0.1,
  ...
  const netY = (0,esm.interpolate)(frame, [0, 660], [height * 0.5 - netSize, height * 0.5 + (isNewWinner ? fishSize : 0)], {
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "#f0f0f0" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: "0", y: height * 0.5, width: "100%", height: riverHeight, fill: "#007acc" }),
    fishPositions.map((fish, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: fish.x,
...
const scene_6_ReservoirSamplingScene = () => {
  ...
  const fishPositions = Array.from({ length: fishCount }, (_, i) => ({
    x: (0,esm.interpolate)(frame, [0, 29], [width + i * fishSize * 2, -fishSize]),
    color: fishColors[i % fishColors.length]
  }));
  const currentFishIndex = Math.floor((0,esm.interpolate)(frame, [0, 29], [0, fishCount - 1], { extrapolateRight: "clamp" }));
  const currentFishColor = fishPositions[currentFishIndex].color;
  const netCatchProgress = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 10, stiffness: 100 }
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#f0f0f0" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", width: "100%", height: riverHeight, top: riverY }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: 0, y: 0, width, height: riverHeight, fill: "#e0f7fa" }) }),
    fishPositions.map((fish, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", width: fishSize, height: fishSize, top: riverY + riverHeight / 2 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: fish.x,
        cy: 0,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", width: netSize, height: netSize, top: riverY + riverHeight / 2, left: netPositionX }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "circle",
      {
        cx: 0,
        cy: 0,
...
const scene_7_ReservoirSamplingScene = () => {
  ...
  const fishPositions = Array.from({ length: fishCount }).map((_, i) => {
    const x = (0,esm.interpolate)(frame + i * 20, [0, 300], [width, -fishSize], {
  ...
  const diceGlow = (0,esm.interpolate)(frame % 30, [0, 15, 30], [0, 1, 0]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "#f0f0f0" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", width: "100%", height: "100%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: 0, y: riverY - height * 0.15, width, height: height * 0.3, fill: "#007acc" }) }),
    fishPositions.map((pos, i) => /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", left: pos.x, top: pos.y }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: 0, cy: 0, r: fishSize / 2, fill: i % 2 === 0 ? "#ffcc00" : "#ff5733" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: fishSize / 4, cy: 0, r: fishSize / 8, fill: "#fff" })
    ] }, i)),
    netPositions.map((pos, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { style: { position: "absolute", left: pos.x, top: pos.y }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "rect",
      {
        x: -netSize / 2,
        y: -netSize / 2,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { style: { position: "absolute", left: width * 0.9, top: height * 0.1 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("rect", { x: -fishSize, y: -fishSize, width: fishSize * 2, height: fishSize * 2, fill: "#fff" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "text",
        {
          x: 0,
...
function Main() {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { background: "#f0f0f0" }, children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 810, durationInFrames: 120, name: "scene_4", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_4, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 930, durationInFrames: 660, name: "scene_5", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_5, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1590, durationInFrames: 30, name: "scene_6", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_6, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1620, durationInFrames: 690, name: "scene_7", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(scene_7, {}) })
  ] });
}
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: "proj-c46f2059-51b9-4973-951b-0dd50f0408a0",
      component: Main,
