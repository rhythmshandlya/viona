...
function Main() {
  ...
  const hue = (0,esm.interpolate)(frame, [0, 300], [250, 290]);
  const titleOpacity = (0,esm.interpolate)(frame, [0, 25], [0, 1], { extrapolateRight: "clamp" });
  const titleY = (0,esm.interpolate)(frame, [0, 40], [80, 0], { extrapolateRight: "clamp" });
  const titleScale = (0,esm.spring)({ frame, fps, config: { damping: 12, stiffness: 100 } });
  ...
  const particles = Array.from({ length: 40 }).map((_, i) => {
    ...
    const size = 3 + i % 5 * 2;
    const particleOpacity = (0,esm.interpolate)(floatY, [-50, height * 0.3, height * 0.7, height + 50], [0, 0.6, 0.6, 0]);
  ...
  const orbitElements = Array.from({ length: 8 }).map((_, i) => {
    ...
    const elementOpacity = (0,esm.interpolate)(frame, [60 + i * 10, 80 + i * 10], [0, 0.8], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
    return { x, y, opacity: elementOpacity };
  });
  const progressStart = 120;
  const progress = (0,esm.interpolate)(frame, [progressStart, progressStart + 120], [0, 100], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const counterValue = Math.floor((0,esm.interpolate)(frame, [progressStart, progressStart + 120], [0, 1e6], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }));
  const subtitleOpacity = (0,esm.interpolate)(frame, [180, 210], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const subtitleY = (0,esm.interpolate)(frame, [180, 220], [30, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: {
    ...
    orbitElements.map((el, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        style: {
          position: "absolute",
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              ...
              children: words.map((word, i) => {
                ...
                const wordOpacity = (0,esm.interpolate)(frame - wordDelay, [0, 20], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
                const wordY = (0,esm.interpolate)(frame - wordDelay, [0, 20], [50, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
                const wordScale = (0,esm.spring)({ frame: frame - wordDelay, fps, config: { damping: 10, stiffness: 120 } });
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                ...
                opacity: (0,esm.interpolate)(frame, [100, 130], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }),
                transform: `scale(${(0,esm.spring)({ frame: frame - 100, fps, config: { damping: 12 } })})`,
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                ...
                borderRadius: 6,
                overflow: "hidden",
                opacity: (0,esm.interpolate)(frame, [progressStart - 20, progressStart], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }),
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: "proj_e3f91ea4_b68a_4bf2_b850_8f0804db81c2",
      component: Main,
