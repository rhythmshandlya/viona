...
const HeapNode = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { style: { opacity: entrance, transform: `scale(${entrance})` }, children: [
    parentX !== void 0 && parentY !== void 0 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "line",
      {
        x1: parentX,
        y1: parentY,
...
const HeapTree = ({ startFrame, isStressed }) => {
  const nodes = [
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: "1080", height: "800", viewBox: "0 0 1080 800", children: nodes.map((n, i) => {
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(
      HeapNode,
      {
        ...
        y: n.y,
        size: 40,
        parentX: parent == null ? void 0 : parent.x,
        parentY: parent == null ? void 0 : parent.y,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      children: particles.map((particle) => {
        ...
        switch (direction) {
          case "right":
            x = (0,esm.interpolate)(progress, [0, 1], [-0.08, 1.08]) * width;
            y = crossPos * height + waveOffset;
            break;
          case "left":
            x = (0,esm.interpolate)(progress, [0, 1], [1.08, -0.08]) * width;
            y = crossPos * height + waveOffset;
            break;
          case "down":
            x = crossPos * width + waveOffset;
            y = (0,esm.interpolate)(progress, [0, 1], [-0.08, 1.08]) * height;
            break;
          case "up":
            x = crossPos * width + waveOffset;
            y = (0,esm.interpolate)(progress, [0, 1], [1.08, -0.08]) * height;
            break;
        }
        ...
        return /* @__PURE__ */ (0,jsx_runtime.jsxs)(react.Fragment, { children: [
          trails && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                position: "absolute",
...
/* harmony default export */ const particles_ParticleStream = ((/* unused pure expression or super */ null && (ParticleStream)));
...
const Counter = ({
  ...
  const rawProgress = (0,esm.interpolate)(
    frame,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "span",
    {
      ...
      children: [
        prefix && /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { opacity: 0.8, marginRight: "0.05em" }, children: prefix }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontFeatureSettings: '"tnum"' }, children: formattedValue }),
        suffix && /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { opacity: 0.8, marginLeft: "0.05em", fontWeight: 500 }, children: suffix })
      ]
    }
  );
};
function applyEasing(progress, style) {
  switch (style) {
    case "bounce":
      if (progress < 0.9) {
        return esm.Easing.out(esm.Easing.cubic)(progress / 0.9) * 1.05;
      }
    ...
    case "dramatic":
      return esm.Easing.bezier(0.22, 1, 0.36, 1)(progress);
    case "smooth":
    default:
...
/* harmony default export */ const data_Counter = ((/* unused pure expression or super */ null && (Counter)));
...
const GlowingOrb = ({
  ...
  const actualSecondaryColor = secondaryColor || GlowingOrb_lightenColor(color, 30);
  const gradient = `
    radial-gradient(circle at 35% 35%, ${GlowingOrb_lightenColor(color, 50)}90, transparent 40%),
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        ring && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            inset 0 ${orbSize * 0.05}px ${orbSize * 0.1}px ${GlowingOrb_lightenColor(color, 40)}30
          `,
              transform: `scale(${scale})`
            }
          }
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              height: "20%",
              borderRadius: "50%",
              background: `linear-gradient(135deg, ${GlowingOrb_lightenColor(color, 60)}80, transparent)`,
              filter: "blur(2px)",
              pointerEvents: "none"
            }
          }
        ),
        sparkle && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              position: "absolute",
            ...
            children: [0, 90, 180, 270].map((angle) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  position: "absolute",
                  ...
                  width: 2,
                  height: orbSize * 0.15,
                  background: `linear-gradient(to bottom, ${GlowingOrb_lightenColor(color, 50)}, transparent)`,
...
function GlowingOrb_lightenColor(hex, percent) {
...
/* harmony default export */ const shapes_GlowingOrb = ((/* unused pure expression or super */ null && (GlowingOrb)));
...
const Proj5b12b0680d544df3931c03803cb7381b = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, height, fps } = (0,esm.useVideoConfig)();
  const { fontSize, minDim } = getResponsiveSizes(width, height);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.bg, color: COLORS.text, fontFamily: "system-ui, sans-serif" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", inset: 0, opacity: 0.15 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      width: "100%",
      height: "100%",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 60, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", height: "100%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
      transform: `translateY(${(0,esm.interpolate)(
        (0,esm.spring)({ frame, fps, config: SPRING_SETTLED }),
        [0, 1],
        [-200, 0]
      )}px)`,
      textAlign: "center"
    }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("h1", { style: { fontSize: fontSize.xl, color: COLORS.accent, textShadow: `0 0 20px ${COLORS.accent}88` }, children: [
      "SYSTEM DESIGN",
      /* @__PURE__ */ (0,jsx_runtime.jsx)("br", {}),
      "CHALLENGE"
    ] }) }) }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 60, durationInFrames: 210, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 200 }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 400, height: 200, border: `4px solid ${COLORS.muted}`, borderTop: "none", borderRadius: "0 0 100px 100px", position: "relative" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: -400, left: 0, width: "100%", height: 400 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ParticleStream, { direction: "down", density: 40, color: COLORS.accent, speed: 2 }) }) }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { marginTop: 200 }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          Counter,
          {
            from: 0,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: fontSize.md, textAlign: "center", marginTop: 20 }, children: "TASKS / SEC" })
      ] })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 270, durationInFrames: 330, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { style: { fontSize: fontSize.lg, marginBottom: 50 }, children: "Priority Queue (Heap)" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(HeapTree, { startFrame: 0 })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 600, durationInFrames: 420, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        position: "absolute",
        top: 200,
        ...
        fontWeight: "bold",
        color: COLORS.danger,
        opacity: (0,esm.interpolate)(frame - 600, [150, 160, 170, 180], [0, 1, 0, 1], { extrapolateRight: "clamp" })
      }, children: "O(log n)" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(HeapTree, { startFrame: 0, isStressed: frame > 750 })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1020, durationInFrames: 570, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { style: { fontSize: fontSize.lg, marginBottom: 50, color: COLORS.success }, children: "O(1) CONSTANT TIME" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        transform: `scale(${(0,esm.spring)({ frame: frame - 1150, fps, config: SPRING_SETTLED })})`
      }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(TimingWheel, { size: minDim * 0.7, slots: 60, rotationSpeed: 0.5 }) }),
      frame > 1350 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        position: "absolute",
        left: (0,esm.interpolate)(frame, [1350, 1380], [200, 540], { extrapolateRight: "clamp" }),
        top: (0,esm.interpolate)(frame, [1350, 1365, 1380], [200, 400, 600], { extrapolateRight: "clamp" }),
        opacity: (0,esm.interpolate)(frame, [1380, 1390], [1, 0], { extrapolateLeft: "clamp" })
      }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(GlowingOrb, { size: 0.5, color: COLORS.accent, sparkle: true }) })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1590, durationInFrames: 630, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "relative" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", left: "50%", top: "50%", transformOrigin: "center", translate: "-50% -50%", zIndex: 0 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(TimingWheel, { size: minDim * 0.9, slots: 60, rotationSpeed: 0.05, accentColor: COLORS.primary, isSecondary: true }) }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { zIndex: 1 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(TimingWheel, { size: minDim * 0.5, slots: 60, rotationSpeed: 3 }) }),
        frame > 2050 && frame < 2200 && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", top: 0, left: 0, width: "100%", height: "100%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ParticleStream, { direction: "down", density: 20, color: COLORS.accent, speed: 3 }) })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "absolute", bottom: 200, fontSize: fontSize.md, textAlign: "center", padding: "0 80px" }, children: "Levels cascade tasks down when they tick!" })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 2250, durationInFrames: 390, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 40, marginBottom: 100 }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(TimingWheel, { size: minDim * 0.3, slots: 12, rotationSpeed: 2, accentColor: COLORS.muted, isSecondary: true }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(TimingWheel, { size: minDim * 0.3, slots: 12, rotationSpeed: -2, accentColor: COLORS.muted, isSecondary: true })
      ] }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 100, alignItems: "center" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
          ...
          transform: `scale(${(0,esm.spring)({ frame: frame - 2450, fps, config: SPRING_SETTLED })})`
        }, children: "KAFKA" }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
          background: COLORS.white,
          color: COLORS.bg,
          ...
          fontWeight: "bold",
          fontSize: fontSize.md,
          transform: `scale(${(0,esm.spring)({ frame: frame - 2470, fps, config: SPRING_SETTLED })})`
        }, children: "NETTY" })
      ] })
    ] }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 2640, durationInFrames: 327, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }, children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { style: { fontSize: fontSize.xl, color: COLORS.accent }, children: "PRASANNA" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: fontSize.md, color: COLORS.muted }, children: "ZOHO ENGINEER" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
        marginTop: 100,
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: "proj-5b12b068-0d54-4df3-931c-03803cb7381b",
      component: Proj5b12b0680d544df3931c03803cb7381b,
