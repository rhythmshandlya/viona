...
const HighBar = () => {
  ...
  const animationProgress = (0,esm.spring)({
  ...
  const glowIntensity = (0,esm.interpolate)(progress, [0, 1], [0, 30], {
...
const HighText = () => {
  ...
  const opacity = frame < TIMING.highKeySync ? 0 : (0,esm.interpolate)(textProgress, [0, 1], [0, 1], {
    extrapolateRight: "clamp"
  });
  const scale = frame < TIMING.highKeySync ? 0 : (0,esm.interpolate)(textProgress, [0, 1], [0.8, 1], {
    extrapolateRight: "clamp"
  });
...
const GoldenArc = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps, width, height } = (0,esm.useVideoConfig)();
  const arcProgress = (0,esm.spring)({
    frame: frame - TIMING.andKeySync,
    fps,
    config: { damping: 22, stiffness: 80, mass: 0.9 }
  });
  const opacity = frame < TIMING.andKeySync ? 0 : (0,esm.interpolate)(arcProgress, [0, 1], [0, 1], {
    extrapolateRight: "clamp"
  });
  ...
  const dashOffset = (0,esm.interpolate)(arcProgress, [0, 1], [pathLength, 0], {
    extrapolateRight: "clamp"
  });
    ...
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("defs", { children: [
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("linearGradient", { id: "goldenGradient", x1: "0%", y1: "0%", x2: "100%", y2: "0%", children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "0%", stopColor: COLORS.primary }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "50%", stopColor: COLORS.secondary }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "100%", stopColor: COLORS.accent })
          ] }),
...
const LowText = () => {
  ...
  const opacity = frame < TIMING.lowKeySync ? 0 : (0,esm.interpolate)(textProgress, [0, 1], [0, 1], {
    extrapolateRight: "clamp"
  });
  const scale = frame < TIMING.lowKeySync ? 0 : (0,esm.interpolate)(textProgress, [0, 1], [0.8, 1], {
    extrapolateRight: "clamp"
  });
...
const MainComposition = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: COLORS.background }, children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(HighBar, {}, "high-bar"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(HighText, {}, "high-text"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(GoldenArc, {}, "golden-arc"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(LowBar, {}, "low-bar"),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(LowText, {}, "low-text")
  ] });
};
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
...
/* harmony default export */ const proj_62946154_dd37_47a1_951b_4a32500eacea = ((/* unused pure expression or super */ null && (MainComposition)));
