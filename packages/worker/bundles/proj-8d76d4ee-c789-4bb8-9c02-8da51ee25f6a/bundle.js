...
const VisualContent = ({ frame, width, height }) => {
  ...
  const floatingParticles = Array.from({ length: 30 }).map((_, i) => {
    ...
    const particleOpacity = (0,esm.interpolate)(floatY, [0, height * 0.5, height], [0, 0.4, 0]);
  ...
  const wordAnimation = words.map((word, i) => {
    const wordDelay = i * 8;
    const wordOpacity = (0,esm.interpolate)(frame - wordDelay, [0, 15], [0, 1], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
    });
    const wordY = (0,esm.interpolate)(frame - wordDelay, [0, 15], [40, 0], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
    });
    const wordScale = (0,esm.spring)({ frame: frame - wordDelay, fps: 30, config: { damping: 10, stiffness: 150 } });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: bgStyle, children: [
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
      ...
      }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { style: { fontSize: width * 0.05, textAlign: "center", margin: 0, color: "rgba(255,255,255,0.7)" }, children: "Millions of comments, one winner." }) })
    ] })
  ] });
};
const Main = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(VisualContent, { frame, width, height });
};
/* harmony default export */ const proj_8d76d4ee_c789_4bb8_9c02_8da51ee25f6a_Main = (Main);
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      id: "proj_8d76d4ee_c789_4bb8_9c02_8da51ee25f6a",
      component: proj_8d76d4ee_c789_4bb8_9c02_8da51ee25f6a_Main,
