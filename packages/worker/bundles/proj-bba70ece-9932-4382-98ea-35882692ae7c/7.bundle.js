"use strict";
(self["webpackChunkopenhands_sandbox"] = self["webpackChunkopenhands_sandbox"] || []).push([[7],{
...
const ColorManagement = {
	...
	workingColorSpace: constants/* LinearSRGBColorSpace */.Zr2,
	...
	convert: function ( color, sourceColorSpace, targetColorSpace ) {
		...
		if ( this.spaces[ sourceColorSpace ].transfer === constants/* SRGBTransfer */.KLL ) {
		...
		if ( this.spaces[ targetColorSpace ].transfer === constants/* SRGBTransfer */.KLL ) {
...
ColorManagement.define( {
	...
	[ constants/* LinearSRGBColorSpace */.Zr2 ]: {
		...
		workingColorSpaceConfig: { unpackColorSpace: constants/* SRGBColorSpace */.er$ },
		outputColorSpaceConfig: { drawingBufferColorSpace: constants/* SRGBColorSpace */.er$ }
	},
