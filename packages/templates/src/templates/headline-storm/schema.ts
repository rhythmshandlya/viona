...
export const schema = z.object({
    ...
    .default([
      {
        ...
        body: 'SAN FRANCISCO — In what industry analysts are calling a watershed moment for the technology sector, OpenAI on Wednesday revealed its most advanced artificial intelligence model yet, demonstrating capabilities that stunned even veteran researchers. The system, which the company has been developing in secret for over a year, represents a significant leap forward in machine reasoning and creativity. Silicon Valley executives who attended a private demonstration described the technology as "nothing short of extraordinary," raising fresh questions about the pace of innovation and its implications for the global workforce. The announcement sent shockwaves through financial markets, with technology stocks surging in after-hours trading. "This changes everything we thought we knew about the timeline," said Dr. James Patterson, head of AI research at Stanford University.',
      ...
      },
      {
        ...
        body: 'The European Commission has unveiled a comprehensive regulatory framework aimed squarely at the rapid advancement of artificial intelligence, with officials singling out OpenAI as a primary catalyst for the urgency of the new legislation. The proposed rules, which have been in development since late last year, would impose strict transparency requirements on AI companies operating in the EU and mandate regular safety audits. Commissioner Thierry Breton said the rules were necessary to ensure that "the transformative power of AI serves European citizens rather than endangering them." The framework is expected to face strong opposition from industry groups.',
        pageRef: 'Read full article \u203A',
      },
      {
        ...
        body: 'A sweeping study released Thursday found that OpenAI technology is now embedded in more than 70 percent of North American universities, fundamentally altering how students learn and how professors teach. The research, conducted jointly by MIT and Stanford, revealed that AI-powered tools have become so deeply integrated into academic workflows that many institutions can no longer function without them. Faculty members reported that student work has improved dramatically in quality, but expressed deep concern about whether graduates are developing genuine critical thinking skills. "We are in uncharted territory," said Dr. Sarah Chen, the study\'s lead researcher.',
        pageRef: 'Read full article \u203A',
      },
      {
        source: 'Reuters',
        ...
        body: 'DAVOS, Switzerland (Reuters) — The chief executive of OpenAI drew the largest audience in the World Economic Forum\'s 54-year history on Tuesday, delivering a keynote that outlined an ambitious vision for the future of human-AI collaboration. Speaking to a packed auditorium with thousands more watching on screens throughout the congress centre, the executive described a world in which AI systems would serve as "intellectual partners" to every person on the planet. The address drew a prolonged standing ovation, though critics were quick to point out the lack of concrete commitments on AI safety.',
        pageRef: '',
      },
      {
        source: 'The Guardian',
        ...
        body: 'Healthcare systems across three continents have reported extraordinary results using artificial intelligence diagnostic tools developed in partnership with OpenAI, according to a landmark study published in The Lancet on Thursday. Research teams demonstrated that the AI systems could identify certain cancers up to 18 months before traditional screening methods, a finding that oncologists are calling "potentially the most significant advance in early detection in decades." The study, which tracked more than 200,000 patients across 14 countries over three years, showed particularly striking results in pancreatic and ovarian cancers.',
        pageRef: 'Read full article \u203A',
      },
      {
        source: 'Bloomberg',
        ...
        body: 'Major Hollywood studios have quietly signed multi-year agreements to integrate OpenAI technology across their production pipelines, according to people with knowledge of the deals, marking the entertainment industry\'s most dramatic technological shift since the transition to streaming. The agreements, valued at hundreds of millions of dollars collectively, cover everything from AI-assisted screenwriting to automated visual effects generation. The deals have provoked fierce backlash from creative unions, which argue that the technology threatens hundreds of thousands of jobs.',
        pageRef: '',
      },
      {
        source: 'BBC News',
        ...
        body: 'Cybersecurity experts from five nations have issued an extraordinary joint warning about the potential security implications of advanced artificial intelligence, with a classified report specifically highlighting concerns about OpenAI models being exploited by hostile state actors and criminal organisations. The report, portions of which were declassified and released to the public on Wednesday, describes several scenarios in which current AI capabilities could be used to generate sophisticated cyberattacks, create convincing disinformation campaigns at unprecedented scale, and develop novel methods of evading existing digital security measures.',
        pageRef: 'More on this story \u203A',
      },
    ]),
  highlightColor: z.string().default('#FFE135'),
  framesPerArticle: z.number().default(8),
  blurEnabled: z.boolean().default(true),
  ...
  colors: z
    .object({
      ...
      accent: z.string().default('#FF3B30'),
